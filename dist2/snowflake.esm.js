...
import '@uniswap/governance/build/GovernorAlpha.json'
import '@uniswap/governance/build/Uni.json'
import { abi as abi$6 } from '@uniswap/liquidity-staker/build/StakingRewards.json'
import { abi as abi$1 } from '@uniswap/merkle-distributor/build/MerkleDistributor.json'
import { abi as abi$4 } from '@uniswap/v2-core/build/IUniswapV2Pair.json'
import { abi as abi$3 } from '@uniswap/v2-periphery/build/IUniswapV2Router02.json'
import { abi as abi$2 } from '@uniswap/v3-periphery/artifacts/contracts/lens/Quoter.sol/Quoter.json'
...
import '@uniswap/v3-periphery/artifacts/contracts/NonfungiblePositionManager.sol/NonfungiblePositionManager.json'
import '@uniswap/v3-periphery/artifacts/contracts/V3Migrator.sol/V3Migrator.json'
import { FACTORY_ADDRESS, Pair, computePairAddress, Trade, Router } from '@uniswap/v2-sdk'
import {
  FACTORY_ADDRESS as FACTORY_ADDRESS$1,
  Route as Route$1,
  Pool as Pool$1,
  Trade as Trade$1,
  computePoolAddress,
...
import {
  X,
  ExternalLink as ExternalLink$1,
  Trash,
  Check,
  ArrowDown,
  Info,
...
import { abi as abi$5 } from '@uniswap/v3-core/artifacts/contracts/interfaces/pool/IUniswapV3PoolState.sol/IUniswapV3PoolState.json'
...
const StyledSVG = _styled.svg.withConfig({
  ...
  ['animation:2s ', ' linear infinite;height:', ';width:', ';path{stroke:', ';}'],
  rotate$2,
  (_ref) => {
    let { size } = _ref
    return size
...
function Loader(_ref4) {
  let { size = '16px', stroke, ...rest } = _ref4
...
function isTokenOnList(tokenAddressMap, token) {
  ...
  return Boolean(
    (token === null || token === void 0 ? void 0 : token.isToken) &&
      ((_tokenAddressMap$toke = tokenAddressMap[token.chainId]) === null || _tokenAddressMap$toke === void 0
        ? void 0
        : _tokenAddressMap$toke[token.address])
  )
}
...
const SvgLogo = (props) =>
  /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement(
      ...
      _path3$1 ||
        (_path3$1 = /*#__PURE__*/ React.createElement('path', {
      ...
      _path6 ||
        (_path6 = /*#__PURE__*/ React.createElement('path', {
      ...
      _path7 ||
        (_path7 = /*#__PURE__*/ React.createElement('path', {
      ...
      _path8 ||
        (_path8 = /*#__PURE__*/ React.createElement('path', {
          fillRule: 'evenodd',
          clipRule: 'evenodd',
      ...
      _path9 ||
        (_path9 = /*#__PURE__*/ React.createElement('path', {
          fillRule: 'evenodd',
          clipRule: 'evenodd',
...
class MiniRpcProvider {
  constructor(chainId, url, batchWaitTimeMs) {
        ...
        if ('error' in result) {
          ...
          reject(
            new RequestError(
              ...
              result === null || result === void 0
                ? void 0
                : (_result$error2 = result.error) === null || _result$error2 === void 0
                ? void 0
                : _result$error2.code,
              result === null || result === void 0
                ? void 0
                : (_result$error3 = result.error) === null || _result$error3 === void 0
                ? void 0
                : _result$error3.data
            )
          )
    ...
    this.request = async (method, params) => {
      ...
      this.batchTimeoutId =
        (_this$batchTimeoutId = this.batchTimeoutId) !== null && _this$batchTimeoutId !== void 0
          ? _this$batchTimeoutId
...
function getNetworkLibrary() {
  ...
  return (networkLibrary =
    (_networkLibrary = networkLibrary) !== null && _networkLibrary !== void 0
      ? _networkLibrary
      : getLibrary(network.provider))
}
...
const applicationSlice = createSlice({
  ...
  reducers: {
    ...
    setImplements3085(state, _ref3) {
      let {
        payload: { implements3085 },
      } = _ref3
      state.implements3085 = implements3085
    },
  },
})
const { updateChainId, updateBlockNumber, setOpenModal, addPopup, removePopup, setImplements3085 } =
...
const DAI_ARBITRUM_ONE = new Token(
  SupportedChainId.ARBITRUM_ONE,
...
const USDT_ARBITRUM_ONE = new Token(
  SupportedChainId.ARBITRUM_ONE,
...
const WBTC_ARBITRUM_ONE = new Token(
  SupportedChainId.ARBITRUM_ONE,
...
class ExtendedEther extends Ether {
  ...
  static onChain(chainId) {
    ...
    return (_this$_cachedEther$ch = this._cachedEther[chainId]) !== null && _this$_cachedEther$ch !== void 0
      ? _this$_cachedEther$ch
...
function useWETHContract(withSignerIfPossible) {
  ...
  return useContract(
    chainId
      ? (_WETH9_EXTENDED$chain = WETH9_EXTENDED[chainId]) === null || _WETH9_EXTENDED$chain === void 0
        ? void 0
        : _WETH9_EXTENDED$chain.address
      : undefined,
    WETH_ABI,
...
function useMulticall2Contract() {
  return useContract(MULTICALL_ADDRESS, abi, false)
}
function useMerkleDistributorContract() {
  return useContract(MERKLE_DISTRIBUTOR_ADDRESS, abi$1, true)
}
...
function useENSAddress(ensName) {
  ...
  const resolverAddressResult =
    (_resolverAddress$resu = resolverAddress.result) === null || _resolverAddress$resu === void 0
      ? void 0
      : _resolverAddress$resu[0]
  ...
  return useMemo(() => {
    ...
    return {
      address: changed
        ? null
        : (_addr$result$ =
            (_addr$result = addr.result) === null || _addr$result === void 0 ? void 0 : _addr$result[0]) !== null &&
          _addr$result$ !== void 0
        ? _addr$result$
        : null,
  ...
  return useMemo(() => {
    ...
    return {
      ENSName: changed
        ? null
        : (_name$result$ =
            (_name$result = name.result) === null || _name$result === void 0 ? void 0 : _name$result[0]) !== null &&
          _name$result$ !== void 0
        ? _name$result$
        : null,
...
function useMonitoringEventCallback() {
  const { chainId } = useActiveWeb3React()
  return useCallback(
    async function log(type, _ref) {
      let { transactionResponse, walletAddress } = _ref
...
function fetchClaimMapping() {
  ...
  return (_FETCH_CLAIM_MAPPING_ = FETCH_CLAIM_MAPPING_PROMISE) !== null && _FETCH_CLAIM_MAPPING_ !== void 0
    ? _FETCH_CLAIM_MAPPING_
...
function fetchClaimFile(key) {
  ...
  return (_FETCH_CLAIM_FILE_PRO = FETCH_CLAIM_FILE_PROMISES[key]) !== null && _FETCH_CLAIM_FILE_PRO !== void 0
    ? _FETCH_CLAIM_FILE_PRO
...
function fetchClaim(account) {
  ...
  return (_FETCH_CLAIM_PROMISES = FETCH_CLAIM_PROMISES[account]) !== null && _FETCH_CLAIM_PROMISES !== void 0
    ? _FETCH_CLAIM_PROMISES
    ...
    fetchClaim(account)
      .then((accountClaimInfo) =>
        setClaimInfo((claimInfo) => {
          return { ...claimInfo, [account]: accountClaimInfo }
        })
      )
      .catch(() => {
        setClaimInfo((claimInfo) => {
          return { ...claimInfo, [account]: null }
        })
      })
  }, [account, chainId])
...
function useUserHasAvailableClaim(account) {
  ...
  return Boolean(
    userClaimData &&
      ...
      ((_isClaimedResult$resu = isClaimedResult.result) === null || _isClaimedResult$resu === void 0
        ? void 0
        : _isClaimedResult$resu[0]) === false
  )
}
      ...
      return distributorContract
        ...
        .then((response) => {
          addTransaction(response, {
            ...
            recipient: account,
            uniAmountRaw:
              unclaimedAmount === null || unclaimedAmount === void 0 ? void 0 : unclaimedAmount.quotient.toString(),
          })
...
const WETH_ONLY = Object.fromEntries(
  Object.entries(WETH9_EXTENDED).map((_ref) => {
    let [key, value] = _ref
    return [key, [value]]
  })
...
;({ ...WETH_ONLY, [SupportedChainId.MAINNET]: [...WETH_ONLY[SupportedChainId.MAINNET], DAI, USDC, USDT, WBTC] })
;({
  [SupportedChainId.MAINNET]: [
    [
...
function useSortedTokensByQuery(tokens, searchQuery) {
  return useMemo(() => {
    ...
    tokens.map((token) => {
      ...
      if (
        ((_token$symbol = token.symbol) === null || _token$symbol === void 0 ? void 0 : _token$symbol.toLowerCase()) ===
        symbolMatch[0]
      ) {
        return exactMatches.push(token)
      } else if (
        (_token$symbol2 = token.symbol) !== null &&
        _token$symbol2 !== void 0 &&
        _token$symbol2.toLowerCase().startsWith(searchQuery.toLowerCase().trim())
      ) {
...
class WrappedTokenInfo {
  ...
  get tags() {
    ...
    return (this._tags = this.tokenInfo.tags.map((tagId) => {
      return { ...listTags[tagId], id: tagId }
    }))
  }
...
function listToTokenMap(list) {
  ...
  const map = list.tokens.reduce((tokenMap, tokenInfo) => {
    ...
    if (
      ((_tokenMap$token$chain = tokenMap[token.chainId]) === null || _tokenMap$token$chain === void 0
        ? void 0
        : _tokenMap$token$chain[token.address]) !== undefined
    ) {
...
function useCombinedTokenMapFromUrls(urls) {
  ...
  return useMemo(() => {
    if (!urls) return {}
    return urls
      .slice() // sort by priority so top priority goes last
      .sort(sortByListPriority)
      .reduce((allTokens, currentUrl) => {
        var _lists$currentUrl

        const current =
          (_lists$currentUrl = lists[currentUrl]) === null || _lists$currentUrl === void 0
            ? void 0
            : _lists$currentUrl.current
...
function useActiveListUrls() {
  ...
  return useMemo(
    () =>
      activeListUrls === null || activeListUrls === void 0
        ? void 0
  ...
  return useMemo(
    () =>
      Object.keys(lists).filter(
        (url) =>
          !(allActiveListUrls !== null && allActiveListUrls !== void 0 && allActiveListUrls.includes(url)) &&
...
function useTokensFromMap(tokenMap, includeUserAdded) {
  ...
  return useMemo(() => {
    ...
    const mapWithoutUrls = Object.keys(
      (_tokenMap$chainId = tokenMap[chainId]) !== null && _tokenMap$chainId !== void 0 ? _tokenMap$chainId : {}
    ).reduce((newMap, address) => {
...
function useUnsupportedTokens() {
  ...
  const l2InferredBlockedTokens = useMemo(() => {
    ...
    return list.tokens.reduce((acc, tokenInfo) => {
      ...
      const bridgeInfo =
        (_tokenInfo$extensions = tokenInfo.extensions) === null || _tokenInfo$extensions === void 0
          ? void 0
    ...
    if (decimals.result) {
      ...
      return new Token(
        ...
        parseStringOrBytes32(
          (_symbol$result = symbol.result) === null || _symbol$result === void 0 ? void 0 : _symbol$result[0],
          (_symbolBytes32$result = symbolBytes32.result) === null || _symbolBytes32$result === void 0
            ? void 0
            : _symbolBytes32$result[0],
          'UNKNOWN'
        ),
        parseStringOrBytes32(
          (_tokenName$result = tokenName.result) === null || _tokenName$result === void 0
            ? void 0
            : _tokenName$result[0],
          (_tokenNameBytes32$res = tokenNameBytes32.result) === null || _tokenNameBytes32$res === void 0
            ? void 0
            : _tokenNameBytes32$res[0],
          'Unknown Token'
        )
      )
    }
...
function useCurrency(currencyId) {
  ...
  const extendedEther = useMemo(
    () =>
      chainId
        ? ExtendedEther.onChain(chainId) // display mainnet when not connected
        : ExtendedEther.onChain(SupportedChainId.MAINNET),
    [chainId]
  )
  ...
  if (
    (weth === null || weth === void 0
      ? void 0
      : (_weth$address = weth.address) === null || _weth$address === void 0
      ? void 0
      : _weth$address.toUpperCase()) ===
    (currencyId === null || currencyId === void 0 ? void 0 : currencyId.toUpperCase())
  )
    return weth
...
function useIsDarkMode() {
  const { userDarkMode, matchesDarkMode } = useAppSelector((_ref) => {
    let {
...
function useUserSlippageTolerance() {
  ...
  return useMemo(
    () => (userSlippageTolerance === 'auto' ? 'auto' : new Percent(userSlippageTolerance, 10000)),
    [userSlippageTolerance]
  )
}
/**
...
const ButtonText = _styled.button.withConfig({
...
const IconWrapper$4 = _styled.div.withConfig({
  ...
  (_ref3) => {
    let { marginRight } = _ref3
    return marginRight !== null && marginRight !== void 0 ? marginRight : 0
  },
  (_ref4) => {
    let { marginLeft } = _ref4
    return marginLeft !== null && marginLeft !== void 0 ? marginLeft : 0
  },
  (_ref5) => {
    let { theme, stroke } = _ref5
    return stroke !== null && stroke !== void 0 ? stroke : theme.blue1
  }
) // A button that triggers some onClick result, but looks like a link.

const LinkStyledButton = _styled.button.withConfig({
  displayName: 'components__LinkStyledButton',
  componentId: 'sc-1cchcrx-3',
})(
  [
    'border:none;text-decoration:none;background:none;cursor:',
    ';color:',
    ';font-weight:500;:hover{text-decoration:',
    ';}:focus{outline:none;text-decoration:',
...
const StyledInternalLink = _styled(Link$1).withConfig({
  displayName: 'components__StyledInternalLink',
  componentId: 'sc-1cchcrx-4',
})(
  [
    'text-decoration:none;cursor:pointer;color:',
    ';font-weight:500;:hover{text-decoration:underline;}:focus{outline:none;text-decoration:underline;}:active{text-decoration:none;}',
  ],
  (_ref10) => {
    let { theme } = _ref10
...
const LinkIcon = _styled(ExternalLink$1).withConfig({
...
const TrashIcon = _styled(Trash).withConfig({
  displayName: 'components__TrashIcon',
  componentId: 'sc-1cchcrx-8',
})(
  [
    'height:16px;width:18px;margin-left:10px;stroke:',
    ';cursor:pointer;align-items:center;justify-content:center;display:flex;:hover{opacity:0.7;}',
  ],
  (_ref13) => {
    let { theme } = _ref13
    return theme.text3
...
`
const UniTokenAnimated = _styled.img.withConfig({
  displayName: 'components__UniTokenAnimated',
  componentId: 'sc-1cchcrx-9',
})(
  [
    'animation:',
    ' 5s cubic-bezier(0.83,0,0.17,1) infinite;padding:2rem 0 0 0;filter:drop-shadow(0px 2px 4px rgba(0,0,0,0.15));',
  ],
  rotateImg
)
...
function ExternalLink(_ref14) {
  let { target = '_blank', href, rel = 'noopener noreferrer', ...rest } = _ref14
...
function ExternalLinkIcon(_ref15) {
  let { target = '_blank', href, rel = 'noopener noreferrer', ...rest } = _ref15
  return /*#__PURE__*/ jsx(LinkIconWrapper, {
    target: target,
    rel: rel,
    href: href,
    onClick: handleClickExternalLink,
...
const CustomLightSpinner = _styled(Spinner$1).withConfig({
...
const TextWrapper$1 = _styled(Text$1).withConfig({
  displayName: 'theme__TextWrapper',
  componentId: 'sc-18nh1jk-0',
})(['color:', ';'], (_ref2) => {
  let { color, theme } = _ref2
  return theme[color]
})
/**
...
const ThemedText = {
  Main(props) {
    return /*#__PURE__*/ jsx(TextWrapper$1, {
      fontWeight: 500,
      color: 'text2',
      ...props,
    })
...
function getExplorerLink(chainId, data, type) {
  ...
  const prefix = `https://${
    (_ETHERSCAN_PREFIXES$c = ETHERSCAN_PREFIXES[chainId]) !== null && _ETHERSCAN_PREFIXES$c !== void 0
      ? _ETHERSCAN_PREFIXES$c
      : ''
  }etherscan.io`
...
const ColumnCenter = _styled(Column).withConfig({
  displayName: 'Column__ColumnCenter',
  componentId: 'sc-1kykgp9-1',
})(['width:100%;align-items:center;'])
const AutoColumn = _styled.div.withConfig({
  displayName: 'Column__AutoColumn',
  componentId: 'sc-1kykgp9-2',
})(
  ['display:grid;grid-auto-rows:auto;grid-row-gap:', ';justify-items:', ';'],
  (_ref) => {
    let { gap } = _ref
...
const Row = _styled(Box).withConfig({
  ...
  [
    'width:',
    ';display:flex;padding:0;align-items:',
    ';justify-content:',
    ';padding:',
    ';border:',
    ';border-radius:',
  ...
  (_ref6) => {
    let { borderRadius } = _ref6
    return borderRadius
  }
)

const RowBetween = _styled(Row).withConfig({
...
const AutoRow = _styled(Row).withConfig({
...
const RowFixed = _styled(Row).withConfig({
...
const InputPanel$1 = _styled.div.withConfig({
  displayName: 'AddressInputPanel__InputPanel',
  componentId: 'sc-1bxpzjo-0',
})(
  ['', ' position:relative;border-radius:1.25rem;background-color:', ';z-index:1;width:100%;'],
  (_ref) => {
    let { theme } = _ref
...
const ContainerRow = _styled.div.withConfig({
  ...
  [
    'display:flex;justify-content:center;align-items:center;border-radius:1.25rem;border:1px solid ',
...
const Input$2 = _styled.input.withConfig({
  displayName: 'AddressInputPanel__Input',
  componentId: 'sc-1bxpzjo-3',
})(
  [
    'font-size:1.25rem;outline:none;border:none;flex:1 1 auto;width:0;background-color:',
    ';transition:color 300ms ',
    ';color:',
    ';overflow:hidden;text-overflow:ellipsis;font-weight:500;width:100%;::placeholder{color:',
    ';}padding:0px;-webkit-appearance:textfield;::-webkit-search-decoration{-webkit-appearance:none;}::-webkit-outer-spin-button,::-webkit-inner-spin-button{-webkit-appearance:none;}::placeholder{color:',
    ';}',
  ],
  (_ref7) => {
    let { theme } = _ref7
...
function AddressInputPanel(_ref12) {
  let { id, className = 'recipient-address-input', label, placeholder, value, onChange } = _ref12
  const { chainId } = useActiveWeb3React()
  ...
  return /*#__PURE__*/ jsx(InputPanel$1, {
    id: id,
    children: /*#__PURE__*/ jsx(ContainerRow, {
      error: error,
      children: /*#__PURE__*/ jsx(InputContainer, {
        children: /*#__PURE__*/ jsxs(AutoColumn, {
          gap: 'md',
          children: [
            /*#__PURE__*/ jsxs(RowBetween, {
              children: [
                /*#__PURE__*/ jsx(ThemedText.Black, {
                  color: theme.text2,
                  fontWeight: 500,
                  fontSize: 14,
                  children:
...
const BaseButton = _styled(Button$1).withConfig({
  ...
  [
    'padding:',
    ';width:',
    ';font-weight:500;text-align:center;border-radius:',
    ';outline:none;border:1px solid transparent;color:white;text-decoration:none;display:flex;justify-content:center;flex-wrap:nowrap;align-items:center;cursor:pointer;position:relative;z-index:1;&:disabled{cursor:auto;pointer-events:none;}will-change:transform;transition:transform 450ms ease;transform:perspective(1px) translateZ(0);> *{user-select:none;}> a{text-decoration:none;}',
  ],
  (_ref) => {
    let { padding } = _ref
...
const ButtonPrimary = _styled(BaseButton).withConfig({
  ...
  [
    ...
    ';color:',
    ';cursor:auto;box-shadow:none;border:1px solid transparent;outline:none;}',
  ],
  (_ref4) => {
    let { theme } = _ref4
    return theme.primary1
...
const ButtonLight = _styled(BaseButton).withConfig({
  ...
  [
    'background-color:',
    ';color:',
    ';font-size:16px;font-weight:500;&:focus{box-shadow:0 0 0 1pt ',
    ';background-color:',
    ';}&:hover{background-color:',
    ';}&:active{box-shadow:0 0 0 1pt ',
    ';background-color:',
    ';}:disabled{opacity:0.4;:hover{cursor:auto;background-color:',
    ';box-shadow:none;border:1px solid transparent;outline:none;}}',
  ],
  (_ref12) => {
    let { theme } = _ref12
  ...
  (_ref14) => {
    let { theme, disabled } = _ref14
    return !disabled && darken(0.03, theme.primary5)
  },
  (_ref15) => {
    let { theme, disabled } = _ref15
    return !disabled && darken(0.03, theme.primary5)
  },
  (_ref16) => {
    let { theme, disabled } = _ref16
    return !disabled && darken(0.03, theme.primary5)
  },
  (_ref17) => {
    let { theme, disabled } = _ref17
    return !disabled && darken(0.05, theme.primary5)
  },
  (_ref18) => {
    let { theme, disabled } = _ref18
    return !disabled && darken(0.05, theme.primary5)
  },
  (_ref19) => {
    let { theme } = _ref19
...
const ButtonGray = _styled(BaseButton).withConfig({
  ...
  [
    'background-color:',
    ';color:',
    ';font-size:16px;font-weight:500;&:hover{background-color:',
  ...
  (_ref22) => {
    let { theme, disabled } = _ref22
    return !disabled && darken(0.05, theme.bg2)
  },
  (_ref23) => {
    let { theme, disabled } = _ref23
    return !disabled && darken(0.1, theme.bg2)
  }
)
const ButtonSecondary = _styled(BaseButton).withConfig({
  ...
  [
    'border:1px solid ',
    ';color:',
    ';background-color:transparent;font-size:16px;border-radius:12px;padding:',
    ';&:focus{box-shadow:0 0 0 1pt ',
    ';border:1px solid ',
    ';}&:hover{border:1px solid ',
    ';}&:active{box-shadow:0 0 0 1pt ',
    ';border:1px solid ',
    ';}&:disabled{opacity:50%;cursor:auto;}a:hover{text-decoration:none;}',
  ],
  (_ref24) => {
    let { theme } = _ref24
...
const ButtonOutlined = _styled(BaseButton).withConfig({
  ...
  [
    ...
    ';}&:hover{box-shadow:0 0 0 1px ',
    ';}&:active{box-shadow:0 0 0 1px ',
...
const ButtonEmpty = _styled(BaseButton).withConfig({
  displayName: 'Button__ButtonEmpty',
  componentId: 'sc-fwrjc2-7',
})(
  [
    'background-color:transparent;color:',
    ';display:flex;justify-content:center;align-items:center;&:focus{text-decoration:underline;}&:hover{text-decoration:none;}&:active{text-decoration:none;}&:disabled{opacity:50%;cursor:auto;}',
  ],
  (_ref44) => {
    let { theme } = _ref44
    return theme.primary1
...
const ButtonConfirmedStyle = _styled(BaseButton).withConfig({
  ...
  ['background-color:', ';color:', ';&:disabled{background-color:', ';color:', ';cursor:auto;}'],
  (_ref45) => {
    let { theme } = _ref45
    return theme.bg3
  },
...
const ButtonErrorStyle = _styled(BaseButton).withConfig({
  ...
  [
    ...
    ';}&:active{box-shadow:0 0 0 1pt ',
    ';background-color:',
    ';}&:disabled{opacity:50%;cursor:auto;box-shadow:none;background-color:',
    ';border:1px solid ',
    ';}',
  ],
  (_ref49) => {
...
function ButtonConfirmed(_ref58) {
  let { confirmed, altDisabledStyle, ...rest } = _ref58

  if (confirmed) {
    return /*#__PURE__*/ jsx(ButtonConfirmedStyle, { ...rest })
  } else {
    return /*#__PURE__*/ jsx(ButtonPrimary, { ...rest, altDisabledStyle: altDisabledStyle })
  }
}
function ButtonError(_ref59) {
  let { error, ...rest } = _ref59

  if (error) {
    return /*#__PURE__*/ jsx(ButtonErrorStyle, { ...rest })
  } else {
    return /*#__PURE__*/ jsx(ButtonPrimary, { ...rest })
  }
}

_styled(ButtonOutlined).withConfig({
...
_styled.div.withConfig({
  ...
  [
    'height:17px;width:17px;border-radius:50%;background-color:',
...
const DataCard = _styled(AutoColumn).withConfig({
...
const CardBGImage = _styled.span.withConfig({
  displayName: 'styled__CardBGImage',
  componentId: 'sc-5nm9ef-1',
})(
  [
    'background:url(',
    ');width:1000px;height:600px;position:absolute;border-radius:12px;opacity:0.4;top:-100px;left:-100px;transform:rotate(-15deg);user-select:none;',
    '',
  ],
  uImage,
  (_ref) => {
...
const CardBGImageSmaller = _styled.span.withConfig({
  displayName: 'styled__CardBGImageSmaller',
  componentId: 'sc-5nm9ef-2',
})(
  [
    'background:url(',
    ');width:1200px;height:1200px;position:absolute;border-radius:12px;top:-300px;left:-300px;opacity:0.4;user-select:none;',
    '',
  ],
  xlUnicorn,
  (_ref2) => {
    let { desaturate } = _ref2
    return desaturate && `filter: saturate(0)`
  }
)
const CardNoise = _styled.span.withConfig({
  displayName: 'styled__CardNoise',
  componentId: 'sc-5nm9ef-3',
})(
  [
    'background:url(',
    ');background-size:cover;mix-blend-mode:overlay;border-radius:12px;width:100%;height:100%;opacity:0.15;position:absolute;top:0;left:0;user-select:none;',
  ],
  noise
)
const CardSection = _styled(AutoColumn).withConfig({
...
const Break$1 = _styled.div.withConfig({
...
const StyledDialogContent = _styled((_ref2) => {
  let { minHeight, maxHeight, mobile, isOpen, ...rest } = _ref2
  return /*#__PURE__*/ jsx(AnimatedDialogContent, { ...rest })
})
  .attrs({
    'aria-label': 'dialog',
  })
  ...
  [
    'overflow-y:auto;&[data-reach-dialog-content]{margin:0 0 2rem 0;background-color:',
    ';border:1px solid ',
    ';box-shadow:0 4px 8px 0 ',
    ';padding:0px;width:50vw;overflow-y:auto;overflow-x:hidden;align-self:',
    ';max-width:420px;',
    ' ',
...
function Modal(_ref11) {
  let { isOpen, onDismiss, minHeight = false, maxHeight = 90, initialFocusRef, children } = _ref11
      ...
      return (
        ...
        /*#__PURE__*/ jsx(
          StyledDialogOverlay,
          {
            ...
            children: /*#__PURE__*/ jsxs(StyledDialogContent, {
              ...(isMobile
                ? {
                    ...bind(),
                    style: {
...
const ContentWrapper$5 = _styled(AutoColumn).withConfig({
  displayName: 'AddressClaimModal__ContentWrapper',
  componentId: 'sc-1qxvqh4-0',
})(['width:100%;'])

const ModalUpper$2 = _styled(DataCard).withConfig({
...
const ConfirmOrLoadingWrapper$1 = _styled.div.withConfig({
...
const ConfirmedIcon$2 = _styled(ColumnCenter).withConfig({
...
function AddressClaimModal(_ref2) {
  ...
  let { isOpen, onDismiss } = _ref2
  const { chainId } = useActiveWeb3React() // state for smart contract input
  ...
  const { address: parsedAddress } = useENS(typed) // used for UI loading states
  ...
  return /*#__PURE__*/ jsxs(Modal, {
    ...
    children: [
      ...
      !attempting &&
        /*#__PURE__*/ jsxs(ContentWrapper$5, {
          gap: 'lg',
          children: [
            /*#__PURE__*/ jsxs(ModalUpper$2, {
              children: [
                /*#__PURE__*/ jsx(CardBGImage, {}),
                /*#__PURE__*/ jsx(CardNoise, {}),
                /*#__PURE__*/ jsxs(CardSection, {
                  gap: 'md',
                  children: [
                    /*#__PURE__*/ jsxs(RowBetween, {
                      children: [
                        /*#__PURE__*/ jsx(ThemedText.White, {
                          fontWeight: 500,
                          children: /*#__PURE__*/ jsx(Trans, {
                            id: 'Claim UNI Token',
                          }),
                        }),
                        /*#__PURE__*/ jsx(CloseIcon$3, {
                ...
                /*#__PURE__*/ jsx(Break$1, {}),
              ],
            }),
            /*#__PURE__*/ jsxs(AutoColumn, {
              gap: 'md',
              style: {
                padding: '1rem',
                paddingTop: '0',
              ...
              children: [
                ...
                /*#__PURE__*/ jsx(ButtonPrimary, {
                  disabled:
                    !isAddress$1(parsedAddress !== null && parsedAddress !== void 0 ? parsedAddress : '') ||
                    !hasAvailableClaim,
                  padding: '16px 16px',
                  width: '100%',
                  $borderRadius: '12px',
      ...
      (attempting || claimConfirmed) &&
        /*#__PURE__*/ jsxs(ConfirmOrLoadingWrapper$1, {
          activeBG: true,
          children: [
            /*#__PURE__*/ jsx(CardNoise, {}),
            /*#__PURE__*/ jsx(CardBGImageSmaller, {
              desaturate: true,
            }),
            /*#__PURE__*/ jsxs(RowBetween, {
              children: [
            ...
            /*#__PURE__*/ jsx(ConfirmedIcon$2, {
              children: !claimConfirmed
                ? /*#__PURE__*/ jsx(CustomLightSpinner, {
                    src: Circle$1,
                    alt: 'loader',
                    size: '90px',
                  })
                : /*#__PURE__*/ jsx(UniTokenAnimated, {
                    width: '72px',
                    src: tokenLogo,
                    alt: 'UNI logo',
                  }),
            ...
            /*#__PURE__*/ jsxs(AutoColumn, {
              ...
              children: [
                /*#__PURE__*/ jsxs(AutoColumn, {
                  ...
                  justify: 'center',
                  children: [
                    /*#__PURE__*/ jsx(ThemedText.LargeHeader, {
                      fontWeight: 600,
                      color: 'black',
                      children: claimConfirmed
                        ? /*#__PURE__*/ jsx(Trans, {
                ...
                claimConfirmed &&
                  /*#__PURE__*/ jsx(Fragment, {
                    children: /*#__PURE__*/ jsxs(ThemedText.SubHeader, {
                      fontWeight: 500,
                      color: 'black',
                      children: [
                        /*#__PURE__*/ jsxs('span', {
...
var burn = createReducer(initialState$7, (builder) =>
  builder.addCase(typeInput$3, (state, _ref) => {
    let {
      payload: { field, typedValue },
    } = _ref
    return { ...state, independentField: field, typedValue }
  })
)
...
var burnV3 = createReducer(initialState$6, (builder) =>
  builder.addCase(selectPercent, (state, _ref) => {
    let {
      payload: { percent },
    } = _ref
...
const removeList = createAction('lists/removeList') // select which lists to search across from loaded lists

const enableList = createAction('lists/enableList')
const disableList = createAction('lists/disableList') // versioning
...
var lists = createReducer(initialState$5, (builder) =>
  builder
    .addCase(fetchTokenList.pending, (state, _ref) => {
      ...
      const current =
        (_state$byUrl$url$curr =
          (_state$byUrl$url = state.byUrl[url]) === null || _state$byUrl$url === void 0
            ? void 0
            : _state$byUrl$url.current) !== null && _state$byUrl$url$curr !== void 0
          ? _state$byUrl$url$curr
          : null
      const pendingUpdate =
        (_state$byUrl$url$pend =
          (_state$byUrl$url2 = state.byUrl[url]) === null || _state$byUrl$url2 === void 0
            ? void 0
            : _state$byUrl$url2.pendingUpdate) !== null && _state$byUrl$url$pend !== void 0
          ? _state$byUrl$url$pend
          : null
      state.byUrl[url] = {
        current,
    ...
    .addCase(fetchTokenList.fulfilled, (state, _ref2) => {
      ...
      const current =
        (_state$byUrl$url3 = state.byUrl[url]) === null || _state$byUrl$url3 === void 0
          ? void 0
          : _state$byUrl$url3.current
      const loadingRequestId =
        (_state$byUrl$url4 = state.byUrl[url]) === null || _state$byUrl$url4 === void 0
          ? void 0
          : _state$byUrl$url4.loadingRequestId // no-op if update does nothing
      ...
      if (current) {
        ...
        if (DEFAULT_ACTIVE_LIST_URLS.includes(url)) {
          ...
          ;(_state$activeListUrls = state.activeListUrls) === null || _state$activeListUrls === void 0
            ? void 0
            : _state$activeListUrls.push(url)
        }
    ...
    .addCase(fetchTokenList.rejected, (state, _ref3) => {
      ...
      if (
        ((_state$byUrl$url5 = state.byUrl[url]) === null || _state$byUrl$url5 === void 0
          ? void 0
          : _state$byUrl$url5.loadingRequestId) !== requestId
      ) {
    ...
    .addCase(acceptListUpdate, (state, _ref8) => {
      ...
      let { payload: url } = _ref8

      if (
        !(
          (_state$byUrl$url6 = state.byUrl[url]) !== null &&
          _state$byUrl$url6 !== void 0 &&
          _state$byUrl$url6.pendingUpdate
        )
      ) {
        throw new Error('accept list update called without pending update')
      }

      state.byUrl[url] = { ...state.byUrl[url], current: state.byUrl[url].pendingUpdate, pendingUpdate: null }
    })
...
function filterToKey(filter) {
  ...
  return `${(_filter$address = filter.address) !== null && _filter$address !== void 0 ? _filter$address : ''}:${
    (_filter$topics$map$jo =
      (_filter$topics = filter.topics) === null || _filter$topics === void 0
        ? void 0
        : (_filter$topics$map = _filter$topics.map((topic) =>
            topic ? (Array.isArray(topic) ? topic.join(';') : topic) : '\0'
          )) === null || _filter$topics$map === void 0
        ? void 0
        : _filter$topics$map.join('-')) !== null && _filter$topics$map$jo !== void 0
      ? _filter$topics$map$jo
      : ''
  }`
}
...
var mint = createReducer(initialState$4, (builder) =>
  builder
    .addCase(resetMintState$1, () => initialState$4)
    .addCase(typeInput$2, (state, _ref) => {
      let {
      ...
      if (noLiquidity) {
        ...
        if (field === state.independentField) {
          ...
          return { ...state, independentField: field, typedValue, otherTypedValue: state.typedValue }
        }
      } else {
        return { ...state, independentField: field, typedValue, otherTypedValue: '' }
      }
    })
)
...
var mintV3 = createReducer(initialState$3, (builder) =>
  builder
    ...
    .addCase(typeStartPriceInput, (state, _ref) => {
      ...
      return { ...state, startPriceTypedValue: typedValue }
    })
    .addCase(typeLeftRangeInput, (state, _ref2) => {
      let {
        payload: { typedValue },
      } = _ref2
      return { ...state, leftRangeTypedValue: typedValue }
    })
    .addCase(typeRightRangeInput, (state, _ref3) => {
      let {
        payload: { typedValue },
      } = _ref3
      return { ...state, rightRangeTypedValue: typedValue }
    })
...
function useAllCurrencyCombinations(currencyA, currencyB) {
  ...
  const bases = useMemo(() => {
    var _BASES_TO_CHECK_TRADE,
      _ADDITIONAL_BASES$cha,
      _ADDITIONAL_BASES$cha2,
      _ADDITIONAL_BASES$cha3,
      _ADDITIONAL_BASES$cha4

    if (!chainId || chainId !== (tokenB === null || tokenB === void 0 ? void 0 : tokenB.chainId)) return []
    const common =
      (_BASES_TO_CHECK_TRADE = BASES_TO_CHECK_TRADES_AGAINST[chainId]) !== null && _BASES_TO_CHECK_TRADE !== void 0
        ? _BASES_TO_CHECK_TRADE
        : []
    const additionalA = tokenA
      ? (_ADDITIONAL_BASES$cha =
          (_ADDITIONAL_BASES$cha2 = ADDITIONAL_BASES[chainId]) === null || _ADDITIONAL_BASES$cha2 === void 0
            ? void 0
            : _ADDITIONAL_BASES$cha2[tokenA.address]) !== null && _ADDITIONAL_BASES$cha !== void 0
        ? _ADDITIONAL_BASES$cha
        : []
      : []
    const additionalB = tokenB
      ? (_ADDITIONAL_BASES$cha3 =
          (_ADDITIONAL_BASES$cha4 = ADDITIONAL_BASES[chainId]) === null || _ADDITIONAL_BASES$cha4 === void 0
            ? void 0
            : _ADDITIONAL_BASES$cha4[tokenB.address]) !== null && _ADDITIONAL_BASES$cha3 !== void 0
        ? _ADDITIONAL_BASES$cha3
        : []
      : []
  ...
  const basePairs = useMemo(
    () =>
      bases
        .flatMap((base) => bases.map((otherBase) => [base, otherBase])) // though redundant with the first filter below, that expression runs more often, so this is probably worthwhile
        .filter((_ref) => {
          let [t0, t1] = _ref
          return !t0.equals(t1)
        }),
...
function useAllCommonPairs(currencyA, currencyB) {
  ...
  return useMemo(
    () =>
      Object.values(
        allPairs // filter out invalid pairs
...
function useBestV2Trade(tradeType, amountSpecified, otherCurrency) {
  let { maxHops = MAX_HOPS } = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {}
    ...
    if (amountSpecified && currencyIn && currencyOut && allowedPairs.length > 0) {
      if (maxHops === 1) {
        ...
        if (tradeType === TradeType.EXACT_INPUT) {
          ...
          return (_Trade$bestTradeExact = Trade.bestTradeExactIn(allowedPairs, amountIn, currencyOut, options)[0]) !==
            null && _Trade$bestTradeExact !== void 0
            ? _Trade$bestTradeExact
            : null
        } else {
          var _Trade$bestTradeExact2

          const amountOut = amountSpecified
          return (_Trade$bestTradeExact2 = Trade.bestTradeExactOut(allowedPairs, currencyIn, amountOut, options)[0]) !==
            null && _Trade$bestTradeExact2 !== void 0
            ? _Trade$bestTradeExact2
            : null
        }
      ...
      for (let i = 1; i <= maxHops; i++) {
        ...
        if (tradeType === TradeType.EXACT_INPUT) {
          ...
          const amountIn = amountSpecified
          currentTrade =
            (_Trade$bestTradeExact3 = Trade.bestTradeExactIn(allowedPairs, amountIn, currencyOut, options)[0]) !==
              null && _Trade$bestTradeExact3 !== void 0
              ? _Trade$bestTradeExact3
              : null
        } else {
          ...
          const amountOut = amountSpecified
          currentTrade =
            (_Trade$bestTradeExact4 = Trade.bestTradeExactOut(allowedPairs, currencyIn, amountOut, options)[0]) !==
              null && _Trade$bestTradeExact4 !== void 0
              ? _Trade$bestTradeExact4
              : null
...
const parseToken = (_ref) => {
  let { address, chainId, decimals, symbol } = _ref
  return new Token(chainId, address, parseInt(decimals.toString()), symbol)
}

const parsePool = (_ref2) => {
  let { fee, sqrtRatioX96, liquidity, tickCurrent, tokenIn, tokenOut } = _ref2
  return new Pool$1(
    parseToken(tokenIn),
    parseToken(tokenOut),
    parseInt(fee),
...
function useRoutingAPIArguments(_ref) {
  let { tokenIn, tokenOut, amount, tradeType } = _ref
...
function useRoutingAPITrade(tradeType, amountSpecified, otherCurrency) {
  ...
  const { isLoading, isError, data } = useGetQuoteQuery(
    queryArgs !== null && queryArgs !== void 0 ? queryArgs : skipToken,
    {
...
const POOL_STATE_INTERFACE = new Interface(abi$5)
let PoolState
  ...
  return useMemo(() => {
    return poolKeys.map((_key, index) => {
      ...
      const [token0, token1, fee] =
        (_transformed$index = transformed[index]) !== null && _transformed$index !== void 0 ? _transformed$index : []
...
function useV3SwapPools(currencyIn, currencyOut) {
  ...
  const allCurrencyCombinationsWithAllFees = useMemo(
    () =>
      allCurrencyCombinations.reduce((list, _ref) => {
...
function useClientSideV3Trade(tradeType, amountSpecified, otherCurrency) {
  ...
  const quotesResults = useSingleContractWithCallData(
    ...
    {
      gasRequired: chainId
        ? (_QUOTE_GAS_OVERRIDES$ = QUOTE_GAS_OVERRIDES[chainId]) !== null && _QUOTE_GAS_OVERRIDES$ !== void 0
          ? _QUOTE_GAS_OVERRIDES$
          : DEFAULT_GAS_QUOTE
        : undefined,
    }
  )
  ...
  const debouncing =
    ...
    (tradeType === TradeType.EXACT_INPUT
      ? !routingAPITrade.trade.inputAmount.equalTo(amountSpecified) ||
        ...
        !(
          debouncedOtherCurrency !== null &&
          debouncedOtherCurrency !== void 0 &&
...
function useGasPrice() {
  ...
  const resultStr =
    (_useSingleCallResult$ = useSingleCallResult(contract, 'latestAnswer').result) === null ||
    _useSingleCallResult$ === void 0
      ? void 0
      : (_useSingleCallResult$2 = _useSingleCallResult$[0]) === null || _useSingleCallResult$2 === void 0
      ? void 0
      : _useSingleCallResult$2.toString()
...
function useCurrentBlockTimestamp() {
  ...
  return (_useSingleCallResult = useSingleCallResult(multicall, 'getCurrentBlockTimestamp')) === null ||
    _useSingleCallResult === void 0
    ? void 0
    : (_useSingleCallResult$ = _useSingleCallResult.result) === null || _useSingleCallResult$ === void 0
    ? void 0
    : _useSingleCallResult$[0]
}
...
function useStakingInfo(pairToFilterBy) {
  const { chainId, account } = useActiveWeb3React() // detect if staking is ended
  ...
  const info = useMemo(() => {
    ...
    return chainId
      ? (_STAKING_REWARDS_INFO =
          (_STAKING_REWARDS_INFO2 = STAKING_REWARDS_INFO[chainId]) === null || _STAKING_REWARDS_INFO2 === void 0
            ? void 0
            : _STAKING_REWARDS_INFO2.filter((stakingRewardInfo) =>
              ...
              )) !== null && _STAKING_REWARDS_INFO !== void 0
        ? _STAKING_REWARDS_INFO
        : []
      : []
  ...
  return useMemo(() => {
    ...
    return rewardsAddresses.reduce((memo, rewardsAddress, index) => {
      ...
      if (
        ...
        !(balanceState !== null && balanceState !== void 0 && balanceState.loading) &&
        !(earnedAmountState !== null && earnedAmountState !== void 0 && earnedAmountState.loading) && // always need these
        totalSupplyState &&
        ...
        var _balanceState$result$,
          _balanceState$result,
          _totalSupplyState$res,
          _rewardRateState$resu,
          _periodFinishState$re,
          _periodFinishState$re2,
          _earnedAmountState$re,
          _earnedAmountState$re2

        if (
          (balanceState !== null && balanceState !== void 0 && balanceState.error) ||
          (earnedAmountState !== null && earnedAmountState !== void 0 && earnedAmountState.error) ||
        ...
        const stakedAmount = CurrencyAmount.fromRawAmount(
          ...
          JSBI.BigInt(
            (_balanceState$result$ =
              balanceState === null || balanceState === void 0
                ? void 0
                : (_balanceState$result = balanceState.result) === null || _balanceState$result === void 0
                ? void 0
                : _balanceState$result[0]) !== null && _balanceState$result$ !== void 0
              ? _balanceState$result$
              : 0
          )
        )
        const totalStakedAmount = CurrencyAmount.fromRawAmount(
          dummyPair.liquidityToken,
          JSBI.BigInt(
            (_totalSupplyState$res = totalSupplyState.result) === null || _totalSupplyState$res === void 0
              ? void 0
              : _totalSupplyState$res[0]
          )
        )
        const totalRewardRate = CurrencyAmount.fromRawAmount(
          uni,
          JSBI.BigInt(
            (_rewardRateState$resu = rewardRateState.result) === null || _rewardRateState$resu === void 0
              ? void 0
              : _rewardRateState$resu[0]
          )
        )
        ...
        const periodFinishSeconds =
          (_periodFinishState$re = periodFinishState.result) === null || _periodFinishState$re === void 0
            ? void 0
            : (_periodFinishState$re2 = _periodFinishState$re[0]) === null || _periodFinishState$re2 === void 0
            ? void 0
            : _periodFinishState$re2.toNumber()
        ...
        memo.push({
          ...
          earnedAmount: CurrencyAmount.fromRawAmount(
            ...
            JSBI.BigInt(
              (_earnedAmountState$re =
                earnedAmountState === null || earnedAmountState === void 0
                  ? void 0
                  : (_earnedAmountState$re2 = earnedAmountState.result) === null || _earnedAmountState$re2 === void 0
                  ? void 0
                  : _earnedAmountState$re2[0]) !== null && _earnedAmountState$re !== void 0
                ? _earnedAmountState$re
                : 0
            )
          ),
...
function useTotalUniEarned() {
  ...
  return useMemo(() => {
    ...
    if (!uni) return undefined
    return (_stakingInfos$reduce =
      stakingInfos === null || stakingInfos === void 0
        ? void 0
        : stakingInfos.reduce(
            (accumulator, stakingInfo) => accumulator.add(stakingInfo.earnedAmount),
            CurrencyAmount.fromRawAmount(uni, '0')
          )) !== null && _stakingInfos$reduce !== void 0
      ? _stakingInfos$reduce
      : CurrencyAmount.fromRawAmount(uni, '0')
  }, [stakingInfos, uni])
      ...
      addresses.reduce((memo, address, i) => {
        ...
        const value =
          results === null || results === void 0
            ? void 0
            : (_results$i = results[i]) === null || _results$i === void 0
            ? void 0
            : (_results$i$result = _results$i.result) === null || _results$i$result === void 0
            ? void 0
            : _results$i$result[0]
        if (value && chainId)
  ...
  const validatedTokens = useMemo(() => {
    ...
    return (_tokens$filter =
      tokens === null || tokens === void 0
        ? void 0
        : tokens.filter((t) => isAddress(t === null || t === void 0 ? void 0 : t.address) !== false)) !== null &&
      _tokens$filter !== void 0
      ? _tokens$filter
      : []
  }, [tokens])
    ...
    () => [
      address && validatedTokens.length > 0
        ? validatedTokens.reduce((memo, token, i) => {
            ...
            const value =
              balances === null || balances === void 0
                ? void 0
                : (_balances$i = balances[i]) === null || _balances$i === void 0
                ? void 0
                : (_balances$i$result = _balances$i.result) === null || _balances$i$result === void 0
                ? void 0
                : _balances$i$result[0]
...
function useCurrencyBalances(account, currencies) {
    ...
    return (_currencies$filter =
      currencies === null || currencies === void 0
        ...
        : currencies.filter((currency) => {
            ...
            return (_currency$isToken = currency === null || currency === void 0 ? void 0 : currency.isToken) !==
              null && _currency$isToken !== void 0
              ? _currency$isToken
              : false
          })) !== null && _currencies$filter !== void 0
      ? _currencies$filter
      : []
  }, [currencies])
  ...
  const containsETH = useMemo(() => {
    ...
    return (_currencies$some =
      currencies === null || currencies === void 0
        ? void 0
        : currencies.some((currency) => (currency === null || currency === void 0 ? void 0 : currency.isNative))) !==
      null && _currencies$some !== void 0
      ? _currencies$some
      : false
  }, [currencies])
...
function useAllTokenBalances() {
  ...
  const allTokensArray = useMemo(
    () => Object.values(allTokens !== null && allTokens !== void 0 ? allTokens : {}),
    [allTokens]
  )
...
function useAggregateUniBalance() {
  ...
  return CurrencyAmount.fromRawAmount(
    ...
    JSBI.add(
      JSBI.add(
        (_uniBalance$quotient = uniBalance === null || uniBalance === void 0 ? void 0 : uniBalance.quotient) !== null &&
          _uniBalance$quotient !== void 0
          ? _uniBalance$quotient
          : JSBI.BigInt(0),
        (_uniUnclaimed$quotien = uniUnclaimed === null || uniUnclaimed === void 0 ? void 0 : uniUnclaimed.quotient) !==
          null && _uniUnclaimed$quotien !== void 0
          ? _uniUnclaimed$quotien
          : JSBI.BigInt(0)
      ),
      (_uniUnHarvested$quoti =
        uniUnHarvested === null || uniUnHarvested === void 0 ? void 0 : uniUnHarvested.quotient) !== null &&
        _uniUnHarvested$quoti !== void 0
        ? _uniUnHarvested$quoti
        : JSBI.BigInt(0)
    )
  )
...
function useDerivedSwapInfo(toggledVersion) {
  ...
  const parsedAmount = useMemo(() => {
    ...
    return tryParseAmount(
      typedValue,
      (_ref2 = isExactIn ? inputCurrency : outputCurrency) !== null && _ref2 !== void 0 ? _ref2 : undefined
    )
  ...
  const v2Trade = useBestV2Trade(
    ...
    (_ref3 = isExactIn ? outputCurrency : inputCurrency) !== null && _ref3 !== void 0 ? _ref3 : undefined
  )
  const v3Trade = useBestV3Trade(
    isExactIn ? TradeType.EXACT_INPUT : TradeType.EXACT_OUTPUT,
    toggledVersion !== Version.v2 ? parsedAmount : undefined,
    (_ref4 = isExactIn ? outputCurrency : inputCurrency) !== null && _ref4 !== void 0 ? _ref4 : undefined
  )
  ...
  if (!parsedAmount) {
    ...
    inputError =
      (_inputError = inputError) !== null && _inputError !== void 0
        ? _inputError
        : /*#__PURE__*/ jsx(Trans, {
            id: 'Enter an amount',
          })
  ...
  if (!currencies[Field.INPUT] || !currencies[Field.OUTPUT]) {
    ...
    inputError =
      (_inputError2 = inputError) !== null && _inputError2 !== void 0
        ? _inputError2
        : /*#__PURE__*/ jsx(Trans, {
            id: 'Select a token',
          })
  ...
  if (!to || !formattedTo) {
    ...
    inputError =
      (_inputError3 = inputError) !== null && _inputError3 !== void 0
        ? _inputError3
        : /*#__PURE__*/ jsx(Trans, {
    ...
    if (BAD_RECIPIENT_ADDRESSES[formattedTo] || (v2Trade && involvesAddress(v2Trade, formattedTo))) {
      ...
      inputError =
        (_inputError4 = inputError) !== null && _inputError4 !== void 0
          ? _inputError4
          : /*#__PURE__*/ jsx(Trans, {
  ...
  const [balanceIn, amountIn] = [
    ...
    bestTrade === null || bestTrade === void 0 ? void 0 : bestTrade.maximumAmountIn(allowedSlippage),
  ]
  ...
  return {
    [Field.INPUT]: {
      currencyId:
        inputCurrency === ''
          ? null
          : (_inputCurrency = inputCurrency) !== null && _inputCurrency !== void 0
          ? _inputCurrency
          : null,
    },
    [Field.OUTPUT]: {
      currencyId:
        outputCurrency === ''
          ? null
          : (_outputCurrency = outputCurrency) !== null && _outputCurrency !== void 0
          ? _outputCurrency
          : null,
    },
...
function useDefaultsFromURLSearch() {
  ...
  useEffect(() => {
    ...
    const inputCurrencyId =
      (_parsed$Field$INPUT$c = parsed[Field.INPUT].currencyId) !== null && _parsed$Field$INPUT$c !== void 0
        ? _parsed$Field$INPUT$c
        : undefined
    const outputCurrencyId =
      (_parsed$Field$OUTPUT$ = parsed[Field.OUTPUT].currencyId) !== null && _parsed$Field$OUTPUT$ !== void 0
        ? _parsed$Field$OUTPUT$
        : undefined
    dispatch(
      replaceSwapState({
...
var swap = createReducer(initialState$2, (builder) =>
  builder
    .addCase(replaceSwapState, (state, _ref) => {
      let {
...
var transactions = createReducer(initialState$1, (builder) =>
  builder
    ...
    .addCase(addTransaction, (transactions, _ref) => {
      ...
      if (
        (_transactions$chainId = transactions[chainId]) !== null &&
        _transactions$chainId !== void 0 &&
        _transactions$chainId[hash]
      ) {
        throw Error('Attempted to add existing transaction.')
      }

      const txs =
        (_transactions$chainId2 = transactions[chainId]) !== null && _transactions$chainId2 !== void 0
          ? _transactions$chainId2
          : {}
      txs[hash] = {
        hash,
        info,
    ...
    .addCase(checkedTransaction, (transactions, _ref3) => {
      ...
      const tx =
        (_transactions$chainId3 = transactions[chainId]) === null || _transactions$chainId3 === void 0
          ? void 0
          : _transactions$chainId3[hash]
    ...
    .addCase(finalizeTransaction, (transactions, _ref4) => {
      ...
      const tx =
        (_transactions$chainId4 = transactions[chainId]) === null || _transactions$chainId4 === void 0
          ? void 0
          : _transactions$chainId4[hash]
...
var user = createReducer(initialState, (builder) =>
  builder
    .addCase(updateVersion, (state) => {
...
const BodyWrapper$2 = _styled.div.withConfig({
...
const CodeBlockWrapper = _styled.div.withConfig({
  ...
  [
    'background:',
    ';overflow:auto;white-space:pre;box-shadow:0px 0px 1px rgba(0,0,0,0.01),0px 4px 8px rgba(0,0,0,0.04),0px 16px 24px rgba(0,0,0,0.04),0px 24px 32px rgba(0,0,0,0.01);border-radius:24px;padding:18px 24px;color:',
    ';',
  ],
  (_ref) => {
    let { theme } = _ref
...
class ErrorBoundary extends React__default.Component {
  ...
  componentDidCatch(error, errorInfo) {
    ReactGA.exception({ ...error, ...errorInfo, fatal: true })
  }
  ...
  render() {
    ...
    if (error !== null) {
      ...
      return /*#__PURE__*/ jsx(FallbackWrapper, {
        children: /*#__PURE__*/ jsx(BodyWrapper$2, {
          children: /*#__PURE__*/ jsxs(AutoColumn, {
            gap: 'md',
            children: [
              /*#__PURE__*/ jsx(SomethingWentWrongWrapper, {
                children: /*#__PURE__*/ jsx(ThemedText.Label, {
                  fontSize: 24,
                  fontWeight: 600,
                  children: /*#__PURE__*/ jsx(Trans, {
              ...
              /*#__PURE__*/ jsx(CodeBlockWrapper, {
                children: /*#__PURE__*/ jsx('code', {
                  children: /*#__PURE__*/ jsx(ThemedText.Main, {
                    fontSize: 10,
                    ...
                    children: [
                      /*#__PURE__*/ jsx(LinkWrapper, {
                        children: /*#__PURE__*/ jsx(ExternalLink, {
                          ...
                          target: '_blank',
                          children: /*#__PURE__*/ jsxs(ThemedText.Link, {
                            fontSize: 16,
                            children: [
                              /*#__PURE__*/ jsx(Trans, {
...
const ContentWrapper$4 = _styled(AutoColumn).withConfig({
  displayName: 'ClaimModal__ContentWrapper',
  componentId: 'sc-gtants-0',
})(['width:100%;'])

const ModalUpper$1 = _styled(DataCard).withConfig({
...
const ConfirmedIcon$1 = _styled(ColumnCenter).withConfig({
...
function ClaimModal() {
  var _userClaimData$flags,
    _userClaimData$flags2,
    _groupSeparator,
    _userClaimData$flags3,
    _userClaimData$flags4,
    _userClaimData$flags5,
    _groupSeparator2

  const isOpen = useModalOpen(ApplicationModal.SELF_CLAIM)
  const toggleClaimModal = useToggleSelfClaimModal()
  const { account, chainId } = useActiveWeb3React() // used for UI loading states
  ...
  const nonLPAmount = JSBI.multiply(
    JSBI.BigInt(
      (userClaimData !== null &&
      userClaimData !== void 0 &&
      (_userClaimData$flags = userClaimData.flags) !== null &&
      _userClaimData$flags !== void 0 &&
      _userClaimData$flags.isSOCKS
        ? SOCKS_AMOUNT
        : 0) +
        (userClaimData !== null &&
        userClaimData !== void 0 &&
        (_userClaimData$flags2 = userClaimData.flags) !== null &&
        _userClaimData$flags2 !== void 0 &&
        _userClaimData$flags2.isUser
          ? USER_AMOUNT
          : 0)
    ),
  ...
  return /*#__PURE__*/ jsxs(Modal, {
    ...
    children: [
      ...
      !attempting &&
        !claimConfirmed &&
        /*#__PURE__*/ jsxs(ContentWrapper$4, {
          gap: 'lg',
          children: [
            /*#__PURE__*/ jsxs(ModalUpper$1, {
              children: [
                /*#__PURE__*/ jsx(CardBGImage, {}),
                /*#__PURE__*/ jsx(CardNoise, {}),
                /*#__PURE__*/ jsxs(CardSection, {
                ...
                /*#__PURE__*/ jsxs(CardSection, {
                  ...
                  children: [
                    (userClaimData === null || userClaimData === void 0
                      ? void 0
                      : (_userClaimData$flags3 = userClaimData.flags) === null || _userClaimData$flags3 === void 0
                      ? void 0
                      : _userClaimData$flags3.isSOCKS) &&
                      /*#__PURE__*/ jsxs(RowBetween, {
                        children: [
                          /*#__PURE__*/ jsx(ThemedText.SubHeader, {
                            color: 'white',
                    ...
                    (userClaimData === null || userClaimData === void 0
                      ? void 0
                      : (_userClaimData$flags4 = userClaimData.flags) === null || _userClaimData$flags4 === void 0
                      ? void 0
                      : _userClaimData$flags4.isLP) &&
                      unclaimedAmount &&
                    ...
                    (userClaimData === null || userClaimData === void 0
                      ? void 0
                      : (_userClaimData$flags5 = userClaimData.flags) === null || _userClaimData$flags5 === void 0
                      ? void 0
                      : _userClaimData$flags5.isUser) &&
                      /*#__PURE__*/ jsxs(RowBetween, {
                        children: [
                          /*#__PURE__*/ jsx(ThemedText.SubHeader, {
                            color: 'white',
            ...
            /*#__PURE__*/ jsxs(AutoColumn, {
              ...
              children: [
                ...
                /*#__PURE__*/ jsx(ButtonPrimary, {
                  disabled: !isAddress$1(account !== null && account !== void 0 ? account : ''),
                  padding: '16px 16px',
                  width: '100%',
                  $borderRadius: '12px',
                  mt: '1rem',
      ...
      (attempting || claimConfirmed) &&
        /*#__PURE__*/ jsxs(ConfirmOrLoadingWrapper, {
          activeBG: true,
          children: [
            /*#__PURE__*/ jsx(CardNoise, {}),
            /*#__PURE__*/ jsx(CardBGImageSmaller, {
            ...
            /*#__PURE__*/ jsxs(AutoColumn, {
              ...
              children: [
                ...
                claimConfirmed &&
                  /*#__PURE__*/ jsx(Fragment, {
                    children: /*#__PURE__*/ jsx(ThemedText.SubHeader, {
                      fontWeight: 500,
                      color: 'black',
                      children: /*#__PURE__*/ jsx(Trans, {
...
const Card = _styled(Box).withConfig({
  ...
  ['width:', ';padding:', ';border-radius:', ';border:', ';'],
  (_ref) => {
    let { width } = _ref
    return width !== null && width !== void 0 ? width : '100%'
  },
...
const LightCard = _styled(Card).withConfig({
...
const LightGreyCard = _styled(Card).withConfig({
...
const GreyCard = _styled(Card).withConfig({
...
const DarkGreyCard = _styled(Card).withConfig({
...
const OutlineCard = _styled(Card).withConfig({
...
_styled(Card).withConfig({
  ...
  ['background-color:', ';color:', ';border-radius:12px;'],
  (_ref13) => {
    let { theme } = _ref13
    return theme.primary5
  },
...
const Wrapper$e = _styled.div.withConfig({
...
const StyledExternalCard = _styled(Card).withConfig({
  ...
  ['background-color:', ';padding:0.5rem;width:100%;:hover,:focus,:active{background-color:', ';}'],
  (_ref) => {
    let { theme } = _ref
    return theme.primary5
  },
...
const HoverText$1 = _styled.div.withConfig({
    ...
    children: /*#__PURE__*/ jsxs(AutoColumn, {
      ...
      children: [
        /*#__PURE__*/ jsxs(RowBetween, {
          ...
          children: [
            /*#__PURE__*/ jsx(ThemedText.MediumHeader, {
              children: /*#__PURE__*/ jsx(Trans, {
                id: 'Legal & Privacy',
              }),
            }),
            /*#__PURE__*/ jsx(HoverText$1, {
              onClick: () => toggle(),
    ...
    children: /*#__PURE__*/ jsxs(AutoColumn, {
      ...
      children: [
        /*#__PURE__*/ jsxs(AutoColumn, {
          ...
          children: [
            /*#__PURE__*/ jsx(StyledExternalCard, {
              children: /*#__PURE__*/ jsx(ExternalLink, {
                href: 'https://uniswap.org/terms-of-service',
                children: /*#__PURE__*/ jsxs(RowBetween, {
                  children: [
                    /*#__PURE__*/ jsxs(AutoRow, {
                      gap: '4px',
                      children: [
        ...
        /*#__PURE__*/ jsxs(AutoColumn, {
          gap: '12px',
          children: [
            EXTERNAL_APIS.map((_ref4, i) => {
              let { name, description } = _ref4
              return /*#__PURE__*/ jsx(
                DarkGreyCard,
                {
                  children: /*#__PURE__*/ jsxs(AutoColumn, {
...
/*eslint-disable*/ const messages = {
  ...
  'By adding this list you are implicitly trusting that the data is correct. Anyone can create a list, including creating fake versions of existing lists and lists that claim to represent projects that do not have one.':
    'By adding this list you are implicitly trusting that the data is correct. Anyone can create a list, including creating fake versions of existing lists and lists that claim to represent projects that do not have one.',
  'By connecting a wallet, you agree to Uniswap Labs’ <0>Terms of Service</0> and acknowledge that you have read and understand the Uniswap <1>Protocol Disclaimer</1>.':
    'By connecting a wallet, you agree to Uniswap Labs’ <0>Terms of Service</0> and acknowledge that you have read and understand the Uniswap <1>Protocol Disclaimer</1>.',
  Canceled: 'Canceled',
  Change: 'Change',
  Charts: 'Charts',
  ...
  'Failed to switch networks from the Uniswap Interface. In order to use Uniswap on {0}, you must change the network in your wallet.':
    [
      'Failed to switch networks from the Uniswap Interface. In order to use Uniswap on ',
      ['0'],
      ', you must change the network in your wallet.',
    ],
  'Fee Tier': 'Fee Tier',
  'Fee tier': 'Fee tier',
  ...
  'Optimism is in Beta and may experience downtime. Optimism expects planned downtime to upgrade the network in the near future. During downtime, your position will not earn fees and you will be unable to remove liquidity. <0>Read more.</0>':
    'Optimism is in Beta and may experience downtime. Optimism expects planned downtime to upgrade the network in the near future. During downtime, your position will not earn fees and you will be unable to remove liquidity. <0>Read more.</0>',
  ...
  'Try Again': 'Try Again',
  'Try increasing your slippage tolerance.<0/>NOTE: Fee on transfer and rebase tokens are incompatible with Uniswap V3.':
    'Try increasing your slippage tolerance.<0/>NOTE: Fee on transfer and rebase tokens are incompatible with Uniswap V3.',
  ...
  'You must give the Uniswap smart contracts permission to use your {0}. You only have to do this once per token.': [
  ...
  'You will receive at least {0} {1} or the transaction will revert.': [
  ...
  'You will send at most {0} {1} or the transaction will revert.': [
...
function navigatorLocale() {
  ...
  if (region) {
    ...
    return (_parseLocale = parseLocale(`${language}-${region.toUpperCase()}`)) !== null && _parseLocale !== void 0
      ? _parseLocale
...
function storeLocale() {
  ...
  return (_store$getState$user$ = store.getState().user.userLocale) !== null && _store$getState$user$ !== void 0
...
const initialLocale =
  (_ref =
    (_ref2 =
      (_parseLocale2 = parseLocale(parsedQueryString().lng)) !== null && _parseLocale2 !== void 0
        ? _parseLocale2
        : storeLocale()) !== null && _ref2 !== void 0
      ? _ref2
      : navigatorLocale()) !== null && _ref !== void 0
    ? _ref
    : DEFAULT_LOCALE
...
function useActiveLocale() {
  ...
  return useMemo(() => {
    ...
    return (_ref3 =
      (_ref4 = urlLocale !== null && urlLocale !== void 0 ? urlLocale : userLocale) !== null && _ref4 !== void 0
        ? _ref4
        : navigatorLocale()) !== null && _ref3 !== void 0
      ? _ref3
      : DEFAULT_LOCALE
  ...
  return useMemo(
    () =>
      !locale
        ? {}
        : {
            to: { ...location, search: stringify({ ...qs, lng: locale }) },
            onClick: () => {
              ReactGA.event({
...
function useOnClickOutside(node, handler) {
  ...
  useEffect(() => {
    const handleClickOutside = (e) => {
      ...
      if (
        (_node$current$contain =
          (_node$current = node.current) === null || _node$current === void 0
            ? void 0
            : _node$current.contains(e.target)) !== null && _node$current$contain !== void 0
          ? _node$current$contain
          : false
      ) {
        return
...
const StyledMenuIcon$1 = _styled(SvgMenu).withConfig({
...
const StyledMenuButton$1 = _styled.button.withConfig({
  displayName: 'Menu__StyledMenuButton',
  componentId: 'sc-12ipqmu-1',
})(
  [
    'width:100%;height:100%;border:none;background-color:transparent;margin:0;padding:0;height:38px;background-color:',
    ';border:1px solid ',
    ';padding:0.15rem 0.5rem;border-radius:12px;:hover,:focus{cursor:pointer;outline:none;border:1px solid ',
    ';}svg{margin-top:2px;}',
  ],
  (_ref2) => {
    let { theme } = _ref2
...
const UNIbutton = _styled(ButtonPrimary).withConfig({
  ...
  [
    'background-color:',
    ';background:radial-gradient(174.47% 188.91% at 1.84% 0%,#ff007a 0%,#2172e5 100%),#edeef2;border:none;',
  ],
  (_ref5) => {
    let { theme } = _ref5
    return theme.bg3
...
const StyledMenu$2 = _styled.div.withConfig({
...
const MenuFlyout$1 = _styled.span.withConfig({
  displayName: 'Menu__MenuFlyout',
  componentId: 'sc-12ipqmu-4',
})(
  [
    'min-width:196px;max-height:350px;overflow:auto;background-color:',
    ';box-shadow:0px 0px 1px rgba(0,0,0,0.01),0px 4px 8px rgba(0,0,0,0.04),0px 16px 24px rgba(0,0,0,0.04),0px 24px 32px rgba(0,0,0,0.01);border:1px solid ',
    ';border-radius:12px;padding:0.5rem;display:flex;flex-direction:column;font-size:16px;position:absolute;top:3rem;z-index:100;',
    ';',
    ';',
  ],
  (_ref6) => {
  ...
  (_ref8) => {
    let { flyoutAlignment = FlyoutAlignment.RIGHT } = _ref8
    return flyoutAlignment === FlyoutAlignment.RIGHT
      ? css`
          right: 0rem;
        `
      : css`
...
const MenuItem$1 = _styled(ExternalLink).withConfig({
  displayName: 'Menu__MenuItem',
  componentId: 'sc-12ipqmu-5',
})(
  [
    'display:flex;flex:1;flex-direction:row;align-items:center;padding:0.5rem 0.5rem;justify-content:space-between;color:',
    ';:hover{color:',
...
const InternalMenuItem = _styled(Link$1).withConfig({
  displayName: 'Menu__InternalMenuItem',
  componentId: 'sc-12ipqmu-6',
})(
  [
    'flex:1;padding:0.5rem 0.5rem;color:',
    ';:hover{color:',
    ';cursor:pointer;text-decoration:none;}> svg{margin-right:8px;}',
  ],
  (_ref12) => {
    let { theme } = _ref12
    return theme.text2
...
const InternalLinkMenuItem = _styled(InternalMenuItem).withConfig({
  ...
  [
    'display:flex;flex-direction:row;align-items:center;padding:0.5rem 0.5rem;justify-content:space-between;text-decoration:none;:hover{color:',
    ';cursor:pointer;text-decoration:none;}',
  ],
  (_ref14) => {
    let { theme } = _ref14
...
const ToggleMenuItem = _styled.button.withConfig({
  ...
  [
    'background-color:transparent;margin:0;padding:0;border:none;display:flex;flex:1;flex-direction:row;align-items:center;padding:0.5rem 0.5rem;justify-content:space-between;font-size:1rem;font-weight:500;color:',
    ';:hover{color:',
    ';cursor:pointer;text-decoration:none;}',
  ],
  (_ref15) => {
...
function LanguageMenu(_ref18) {
  let { close } = _ref18
  const activeLocale = useActiveLocale()
  return /*#__PURE__*/ jsxs(MenuFlyout$1, {
    children: [
      /*#__PURE__*/ jsx(ToggleMenuItem, {
        onClick: close,
...
function Menu() {
  ...
  return /*#__PURE__*/ jsxs(Fragment, {
    children: [
      /*#__PURE__*/ jsxs(StyledMenu$2, {
        ref: node,
        children: [
          /*#__PURE__*/ jsx(StyledMenuButton$1, {
            onClick: toggleMenu,
            'aria-label':
              /*i18n*/
              i18n._('Menu'),
            children: /*#__PURE__*/ jsx(StyledMenuIcon$1, {}),
          }),
          open &&
            (() => {
              switch (menu) {
                case 'lang':
                  return /*#__PURE__*/ jsx(LanguageMenu, {
                    close: () => setMenu('main'),
                  })
...
`
const LoadingRows = _styled.div.withConfig({
  displayName: 'styled__LoadingRows',
  componentId: 'sc-u7b06n-0',
})(
  [
    'display:grid;& > div{animation:',
    ' 1.5s infinite;animation-fill-mode:both;background:linear-gradient( to left,',
    ' 25%,',
    ' 50%,',
    ' 75% );background-size:400%;border-radius:12px;height:2.4em;will-change:background-position;}',
  ],
  loadingAnimation,
  (_ref) => {
    let { theme } = _ref
...
`
const LoadingOpacityContainer = _styled.div.withConfig({
...
const PopoverContainer$1 = _styled.div.withConfig({
  displayName: 'Popover__PopoverContainer',
  componentId: 'sc-d5tbhs-0',
})(
  ['z-index:9999;visibility:', ';opacity:', ';transition:visibility 150ms linear,opacity 150ms linear;color:', ';'],
  (props) => (props.show ? 'visible' : 'hidden'),
  (props) => (props.show ? 1 : 0),
  (_ref) => {
    let { theme } = _ref
    return theme.text2
  }
...
const Arrow = _styled.div.withConfig({
  ...
  [
    "width:8px;height:8px;z-index:9998;::before{position:absolute;width:8px;height:8px;z-index:9998;content:'';border:1px solid ",
...
function Popover(_ref4) {
  ...
  let { content, show, children, placement = 'auto' } = _ref4
  ...
  return /*#__PURE__*/ jsxs(Fragment, {
    children: [
      /*#__PURE__*/ jsx(ReferenceElement, {
        ref: setReferenceElement,
        children: children,
      }),
      /*#__PURE__*/ jsx(Portal, {
        children: /*#__PURE__*/ jsxs(PopoverContainer$1, {
          show: show,
          ...
          children: [
            ...
            /*#__PURE__*/ jsx(Arrow, {
              className: `arrow-${
                (_attributes$popper$da =
                  (_attributes$popper = attributes.popper) === null || _attributes$popper === void 0
                    ? void 0
                    : _attributes$popper['data-popper-placement']) !== null && _attributes$popper$da !== void 0
                  ? _attributes$popper$da
                  : ''
              }`,
              ref: setArrowElement,
...
const TooltipContainer = _styled.div.withConfig({
  displayName: 'Tooltip__TooltipContainer',
  componentId: 'sc-1g1kijt-0',
})(
  [
    'width:256px;padding:0.6rem 1rem;font-weight:400;word-break:break-word;background:',
...
function TooltipContent(_ref5) {
  let { content, wrap = false, ...rest } = _ref5
  return /*#__PURE__*/ jsx(Popover, {
    content: wrap
      ? /*#__PURE__*/ jsx(TooltipContainer, {
          children: content,
        })
      : content,
    ...rest,
...
function MouseoverTooltipContent(_ref7) {
  let { content, children, onOpen: openCallback = undefined, ...rest } = _ref7
  const [show, setShow] = useState(false)
...
function TradePrice(_ref) {
  ...
  let { price, showInverted, setShowInverted } = _ref
  const theme = useContext(ThemeContext)
  ...
  try {
    ...
    formattedPrice = showInverted
      ...
      : (_price$invert = price.invert()) === null || _price$invert === void 0
      ? void 0
      : _price$invert.toSignificant(4)
  } catch (error) {
    formattedPrice = '0'
  }
  ...
  const label = showInverted
    ? `${
        (_price$quoteCurrency = price.quoteCurrency) === null || _price$quoteCurrency === void 0
          ? void 0
          : _price$quoteCurrency.symbol
      }`
    : `${
        (_price$baseCurrency = price.baseCurrency) === null || _price$baseCurrency === void 0
          ? void 0
          : _price$baseCurrency.symbol
      } `
  const labelInverted = showInverted
    ? `${
        (_price$baseCurrency2 = price.baseCurrency) === null || _price$baseCurrency2 === void 0
          ? void 0
          : _price$baseCurrency2.symbol
      } `
    : `${
        (_price$quoteCurrency2 = price.quoteCurrency) === null || _price$quoteCurrency2 === void 0
          ? void 0
          : _price$quoteCurrency2.symbol
      }`
  const flipPrice = useCallback(() => setShowInverted(!showInverted), [setShowInverted, showInverted])
  const text = `${
    (_ref2 = '1 ' + labelInverted + ' = ' + formattedPrice) !== null && _ref2 !== void 0 ? _ref2 : '-'
  } ${label}`
  return /*#__PURE__*/ jsxs(StyledPriceContainer, {
    onClick: flipPrice,
    title: text,
    children: [
      /*#__PURE__*/ jsx(Text$1, {
      ...
      ' ',
      usdcPrice &&
        /*#__PURE__*/ jsx(ThemedText.DarkGray, {
          children: /*#__PURE__*/ jsx(Trans, {
            id: '(${0})',
            values: {
...
const Wrapper$d = _styled.div.withConfig({
  displayName: 'styleds__Wrapper',
  componentId: 'sc-11ce2lf-0',
})(['position:relative;padding:8px;'])
const ArrowWrapper$1 = _styled.div.withConfig({
  displayName: 'styleds__ArrowWrapper',
  componentId: 'sc-11ce2lf-1',
})(
  [
    'padding:4px;border-radius:12px;height:32px;width:32px;position:relative;margin-top:-14px;margin-bottom:-14px;left:calc(50% - 16px);background-color:',
    ';border:4px solid ',
    ';z-index:2;',
    '',
  ],
...
const SectionBreak = _styled.div.withConfig({
...
const ErrorText = _styled(Text$1).withConfig({
  displayName: 'styleds__ErrorText',
  componentId: 'sc-11ce2lf-3',
})(['color:', ';'], (_ref5) => {
  let { theme, severity } = _ref5
...
const TruncatedText = _styled(Text$1).withConfig({
...
const Dots = _styled.span.withConfig({
...
const SwapCallbackErrorInner = _styled.div.withConfig({
  ...
  [
    'background-color:',
    ';border-radius:1rem;display:flex;align-items:center;font-size:0.825rem;width:100%;padding:3rem 1.25rem 1rem 1rem;margin-top:-2rem;color:',
    ';z-index:-1;p{padding:0;margin:0;font-weight:500;}',
  ],
  (_ref6) => {
    let { theme } = _ref6
...
const SwapCallbackErrorInnerAlertTriangle = _styled.div.withConfig({
  ...
  [
    'background-color:',
    ';display:flex;align-items:center;justify-content:center;margin-right:12px;border-radius:12px;min-width:48px;height:48px;',
  ],
  (_ref8) => {
    let { theme } = _ref8
    return transparentize(0.9, theme.red1)
...
function SwapCallbackError(_ref9) {
  let { error } = _ref9
  return /*#__PURE__*/ jsxs(SwapCallbackErrorInner, {
    children: [
      /*#__PURE__*/ jsx(SwapCallbackErrorInnerAlertTriangle, {
...
const SwapShowAcceptChanges = _styled(AutoColumn).withConfig({
  displayName: 'styleds__SwapShowAcceptChanges',
  componentId: 'sc-11ce2lf-8',
})(
  ['background-color:', ';color:', ';padding:0.5rem;border-radius:12px;margin-top:8px;'],
  (_ref10) => {
    let { theme } = _ref10
...
const TransactionDetailsLabel = _styled(ThemedText.Black).withConfig({
...
const ResponsiveTooltipContainer = _styled(TooltipContainer).withConfig({
  displayName: 'styleds__ResponsiveTooltipContainer',
  componentId: 'sc-11ce2lf-10',
})(
  ['background-color:', ';border:1px solid ', ';padding:1rem;width:', ';', ''],
  (_ref13) => {
    let { theme } = _ref13
    return theme.bg0
  },
...
function uriToHttp(uri) {
  ...
  switch (protocol) {
    ...
    case 'ipfs':
      const hash =
        (_uri$match = uri.match(/^ipfs:(\/\/)?(.*)$/i)) === null || _uri$match === void 0 ? void 0 : _uri$match[2]
      return [`https://cloudflare-ipfs.com/ipfs/${hash}/`, `https://ipfs.io/ipfs/${hash}/`]

    case 'ipns':
      const name =
        (_uri$match2 = uri.match(/^ipns:(\/\/)?(.*)$/i)) === null || _uri$match2 === void 0 ? void 0 : _uri$match2[2]
      return [`https://cloudflare-ipfs.com/ipns/${name}/`, `https://ipfs.io/ipns/${name}/`]

    case 'ar':
      const tx =
        (_uri$match3 = uri.match(/^ar:(\/\/)?(.*)$/i)) === null || _uri$match3 === void 0 ? void 0 : _uri$match3[2]
...
function useAvatarFromNFT() {
  ...
  const [, erc] =
    (_parts$1$split = (_parts$ = parts[1]) === null || _parts$ === void 0 ? void 0 : _parts$.split('/')) !== null &&
    _parts$1$split !== void 0
      ? _parts$1$split
      : []
  const [contractAddress, id] =
    (_parts$2$split = (_parts$2 = parts[2]) === null || _parts$2 === void 0 ? void 0 : _parts$2.split('/')) !== null &&
    _parts$2$split !== void 0
      ? _parts$2$split
      : []
...
function useERC721Uri(contractAddress, id, enforceOwnership) {
  ...
  return useMemo(() => {
    ...
    return {
      uri:
        !enforceOwnership ||
        account === ((_owner$result = owner.result) === null || _owner$result === void 0 ? void 0 : _owner$result[0])
          ? (_uri$result = uri.result) === null || _uri$result === void 0
            ? void 0
            : _uri$result[0]
          : undefined,
...
function useERC1155Uri(contractAddress, id, enforceOwnership) {
  ...
  return useMemo(() => {
    ...
    return {
      uri:
        !enforceOwnership ||
        ((_balance$result = balance.result) === null || _balance$result === void 0 ? void 0 : _balance$result[0]) > 0
          ? (_uri$result2 = uri.result) === null || _uri$result2 === void 0
            ? void 0
            : _uri$result2[0]
          : undefined,
...
function Identicon() {
  ...
  return /*#__PURE__*/ jsx(StyledIdenticon, {
    children:
      avatar && fetchable
...
const SvgX = (props) =>
  /*#__PURE__*/ React.createElement(
    ...
    _line$1 ||
      (_line$1 = /*#__PURE__*/ React.createElement('line', {
        x1: 18,
        y1: 6,
        x2: 6,
        y2: 18,
    ...
    _line2 ||
      (_line2 = /*#__PURE__*/ React.createElement('line', {
        x1: 6,
        y1: 6,
        x2: 18,
        y2: 18,
...
const CopyIcon = _styled(LinkStyledButton).withConfig({
  ...
  [
    'color:',
    ';flex-shrink:0;display:flex;text-decoration:none;font-size:0.825rem;:hover,:active,:focus{text-decoration:none;color:',
    ';}',
  ],
  (_ref) => {
    let { theme } = _ref
...
const TransactionStatusText$1 = _styled.span.withConfig({
...
function CopyHelper(props) {
  ...
  return /*#__PURE__*/ jsxs(CopyIcon, {
    onClick: () => setCopied(props.toCopy),
    children: [
      isCopied
        ? /*#__PURE__*/ jsxs(TransactionStatusText$1, {
            children: [
              /*#__PURE__*/ jsx(CheckCircle, {
                size: '16',
              }),
              /*#__PURE__*/ jsx(TransactionStatusText$1, {
                children: /*#__PURE__*/ jsx(Trans, {
                  id: 'Copied',
                }),
              }),
...
function FormattedCurrencyAmount(_ref) {
  let { rawAmount, symbol, decimals, sigFigs } = _ref
  return /*#__PURE__*/ jsxs(Fragment, {
...
function FormattedCurrencyAmountManaged(_ref2) {
  ...
  let { rawAmount, currencyId, sigFigs = 6 } = _ref2
  const currency = useCurrency(currencyId)
  return currency
    ? /*#__PURE__*/ jsx(FormattedCurrencyAmount, {
        rawAmount: rawAmount,
...
function ClaimSummary(_ref3) {
  ...
  return typeof uniAmountRaw === 'string'
    ? /*#__PURE__*/ jsx(Trans, {
        ...
        components: {
          0: /*#__PURE__*/ jsx(FormattedCurrencyAmount, {
...
function WrapSummary(_ref7) {
  let {
    info: { currencyAmountRaw, unwrapped },
  } = _ref7
...
function RemoveLiquidityV3Summary(_ref11) {
  ...
  return /*#__PURE__*/ jsx(Trans, {
    id: 'Remove <0/> and <1/>',
    components: {
      0: /*#__PURE__*/ jsx(FormattedCurrencyAmountManaged, {
        rawAmount: expectedAmountBaseRaw,
        currencyId: baseCurrencyId,
        sigFigs: 3,
      }),
      1: /*#__PURE__*/ jsx(FormattedCurrencyAmountManaged, {
...
function TransactionSummary(_ref15) {
  ...
  switch (info.type) {
    case TransactionType.ADD_LIQUIDITY_V3_POOL:
      return /*#__PURE__*/ jsx(AddLiquidityV3PoolSummary, {
        info: info,
      })

    case TransactionType.ADD_LIQUIDITY_V2_POOL:
      return /*#__PURE__*/ jsx(AddLiquidityV2PoolSummary, {
        info: info,
      })

    case TransactionType.CLAIM:
      return /*#__PURE__*/ jsx(ClaimSummary, {
        info: info,
      })

    case TransactionType.DEPOSIT_LIQUIDITY_STAKING:
      return /*#__PURE__*/ jsx(DepositLiquidityStakingSummary, {
        info: info,
      })

    case TransactionType.WITHDRAW_LIQUIDITY_STAKING:
      return /*#__PURE__*/ jsx(WithdrawLiquidityStakingSummary, {
        info: info,
      })

    case TransactionType.SWAP:
      return /*#__PURE__*/ jsx(SwapSummary, {
        info: info,
      })

    case TransactionType.APPROVAL:
      return /*#__PURE__*/ jsx(ApprovalSummary, {
        info: info,
      })

    case TransactionType.VOTE:
      return /*#__PURE__*/ jsx(VoteSummary, {
        info: info,
      })

    case TransactionType.DELEGATE:
      return /*#__PURE__*/ jsx(DelegateSummary, {
        info: info,
      })

    case TransactionType.WRAP:
      return /*#__PURE__*/ jsx(WrapSummary, {
        info: info,
      })

    case TransactionType.CREATE_V3_POOL:
      return /*#__PURE__*/ jsx(CreateV3PoolSummary, {
        info: info,
      })

    case TransactionType.MIGRATE_LIQUIDITY_V3:
      return /*#__PURE__*/ jsx(MigrateLiquidityToV3Summary, {
        info: info,
      })

    case TransactionType.COLLECT_FEES:
      return /*#__PURE__*/ jsx(CollectFeesSummary, {
        info: info,
      })

    case TransactionType.REMOVE_LIQUIDITY_V3:
      return /*#__PURE__*/ jsx(RemoveLiquidityV3Summary, {
        info: info,
      })

    case TransactionType.SUBMIT_PROPOSAL:
      return /*#__PURE__*/ jsx(SubmitProposalTransactionSummary, {
        info: info,
      })
  }
}
...
const TransactionState = _styled(ExternalLink).withConfig({
  ...
  [
    'display:flex;justify-content:space-between;align-items:center;text-decoration:none !important;border-radius:0.5rem;padding:0.25rem 0rem;font-weight:500;font-size:0.825rem;color:',
    ';',
  ],
  (_ref) => {
    let { theme } = _ref
...
const IconWrapper$3 = _styled.div.withConfig({
  displayName: 'Transaction__IconWrapper',
  componentId: 'sc-1epcs64-2',
})(['color:', ';'], (_ref2) => {
  let { pending, success, theme } = _ref2
...
function Transaction(_ref3) {
  ...
  const success =
    !pending &&
    tx &&
    (((_tx$receipt = tx.receipt) === null || _tx$receipt === void 0 ? void 0 : _tx$receipt.status) === 1 ||
      typeof ((_tx$receipt2 = tx.receipt) === null || _tx$receipt2 === void 0 ? void 0 : _tx$receipt2.status) ===
        'undefined')
  if (!chainId) return null
  return /*#__PURE__*/ jsx('div', {
    children: /*#__PURE__*/ jsxs(TransactionState, {
      href: getExplorerLink(chainId, hash, ExplorerDataType.TRANSACTION),
      pending: pending,
      success: success,
      children: [
        /*#__PURE__*/ jsx(RowFixed, {
          children: /*#__PURE__*/ jsxs(TransactionStatusText, {
            children: [
              /*#__PURE__*/ jsx(TransactionSummary, {
                info: info,
              }),
              ' \u2197',
            ],
...
const HeaderRow$1 = _styled.div.withConfig({
...
const UpperSection$1 = _styled.div.withConfig({
...
const InfoCard$1 = _styled.div.withConfig({
  displayName: 'AccountDetails__InfoCard',
  componentId: 'sc-1ir7xlr-2',
})(
  [
    'padding:1rem;border:1px solid ',
    ';border-radius:20px;position:relative;display:grid;grid-row-gap:12px;margin-bottom:20px;',
  ],
  (_ref4) => {
    let { theme } = _ref4
    return theme.bg3
...
const AccountGroupingRow = _styled.div.withConfig({
  ...
  ['', ';justify-content:space-between;align-items:center;font-weight:400;color:', ';div{', ' align-items:center;}'],
  (_ref5) => {
    let { theme } = _ref5
    return theme.flexRowNoWrap
  },
...
const LowerSection = _styled.div.withConfig({
  ...
  [
    '',
    ' padding:1.5rem;flex-grow:1;overflow:auto;background-color:',
    ';border-bottom-left-radius:20px;border-bottom-right-radius:20px;h5{margin:0;font-weight:400;color:',
    ';}',
  ],
  (_ref9) => {
    let { theme } = _ref9
...
const AddressLink = _styled(ExternalLink).withConfig({
  ...
  ['font-size:0.825rem;color:', ';margin-left:1rem;font-size:0.825rem;display:flex;:hover{color:', ';}'],
  (_ref12) => {
    let { theme } = _ref12
    return theme.text3
  },
...
const CloseIcon$2 = _styled.div.withConfig({
...
const CloseColor$1 = _styled(SvgX).withConfig({
...
const IconWrapper$2 = _styled.div.withConfig({
  displayName: 'AccountDetails__IconWrapper',
  componentId: 'sc-1ir7xlr-12',
})(
  ['', ';align-items:center;justify-content:center;margin-right:8px;& > img,span{height:', ';width:', ';}', ';'],
  (_ref16) => {
    let { theme } = _ref16
    return theme.flexColumnNoWrap
  },
...
function WrappedStatusIcon$1(_ref20) {
  let { connector } = _ref20
  return /*#__PURE__*/ jsxs(IconWrapper$2, {
    size: 16,
    children: [
...
function renderTransactions(transactions) {
  return /*#__PURE__*/ jsx(TransactionListWrapper, {
...
function AccountDetails(_ref23) {
  let { toggleWalletModal, pendingTransactions, confirmedTransactions, ENSName, openOptions } = _ref23
  ...
  function formatConnectorName() {
    ...
    return /*#__PURE__*/ jsx(WalletName, {
      children: /*#__PURE__*/ jsx(Trans, {
  ...
  return /*#__PURE__*/ jsxs(Fragment, {
    children: [
      /*#__PURE__*/ jsxs(UpperSection$1, {
        children: [
          /*#__PURE__*/ jsx(CloseIcon$2, {
            onClick: toggleWalletModal,
            children: /*#__PURE__*/ jsx(CloseColor$1, {}),
          }),
          ...
          /*#__PURE__*/ jsx(AccountSection, {
            children: /*#__PURE__*/ jsx(YourAccount, {
              children: /*#__PURE__*/ jsxs(InfoCard$1, {
                children: [
                  /*#__PURE__*/ jsxs(AccountGroupingRow, {
                    children: [
                      formatConnectorName(),
                      /*#__PURE__*/ jsxs('div', {
                        children: [
                  ...
                  /*#__PURE__*/ jsx(AccountGroupingRow, {
                    id: 'web3-account-identifier-row',
                    children: /*#__PURE__*/ jsx(AccountControl, {
                      children: ENSName
                        ? /*#__PURE__*/ jsx(Fragment, {
                            children: /*#__PURE__*/ jsxs('div', {
                              children: [
                                connector &&
                                  /*#__PURE__*/ jsx(WrappedStatusIcon$1, {
                                    connector: connector,
                                  }),
                                /*#__PURE__*/ jsxs('p', {
                                  children: [' ', ENSName],
      ...
      !!pendingTransactions.length || !!confirmedTransactions.length
        ? /*#__PURE__*/ jsxs(LowerSection, {
            children: [
              /*#__PURE__*/ jsxs(AutoRow, {
                ...
                children: [
                  /*#__PURE__*/ jsx(ThemedText.Body, {
                    children: /*#__PURE__*/ jsx(Trans, {
                      id: 'Recent Transactions',
                    }),
                  }),
                  /*#__PURE__*/ jsx(LinkStyledButton, {
        ...
        : /*#__PURE__*/ jsx(LowerSection, {
            children: /*#__PURE__*/ jsx(ThemedText.Body, {
              color: theme.text1,
              children: /*#__PURE__*/ jsx(Trans, {
...
const InfoCard = _styled.button.withConfig({
  ...
  [
    'background-color:',
    ';padding:1rem;outline:none;border:1px solid;border-radius:12px;width:100% !important;&:focus{box-shadow:0 0 0 1px ',
    ';}border-color:',
    ';',
  ],
  (_ref) => {
    let { theme, active } = _ref
...
const GreenCircle = _styled.div.withConfig({
  ...
  [
    '',
    ' justify-content:center;align-items:center;&:first-child{height:8px;width:8px;margin-right:8px;background-color:',
    ';border-radius:50%;}',
  ],
  (_ref8) => {
    let { theme } = _ref8
...
const IconWrapper$1 = _styled.div.withConfig({
...
function Option$1(_ref19) {
  ...
  const content = /*#__PURE__*/ jsxs(OptionCardClickable, {
    id: id,
    onClick: onClick,
    clickable: clickable && !active,
    active: active,
    children: [
      /*#__PURE__*/ jsxs(OptionCardLeft, {
        children: [
          /*#__PURE__*/ jsxs(HeaderText, {
            color: color,
            children: [
              active
                ? /*#__PURE__*/ jsx(CircleWrapper, {
                    children: /*#__PURE__*/ jsx(GreenCircle, {
                      children: /*#__PURE__*/ jsx('div', {}),
                    }),
                  })
                : '',
...
const LoadingMessage = _styled.div.withConfig({
  ...
  [
    '',
    ';align-items:center;justify-content:flex-start;border-radius:12px;margin-bottom:20px;color:',
    ';border:1px solid ',
    ';& > *{padding:1rem;}',
  ],
  (_ref2) => {
  ...
  (_ref3) => {
    let { theme, error } = _ref3
    return error ? theme.red1 : 'inherit'
  },
  (_ref4) => {
    let { theme, error } = _ref4
...
const ErrorButton = _styled.div.withConfig({
  ...
  [
    ...
    ';background-color:',
    ';margin-left:1rem;padding:0.5rem;font-weight:600;user-select:none;&:hover{cursor:pointer;background-color:',
    ';}',
  ],
  (_ref6) => {
    let { theme } = _ref6
...
function PendingView(_ref10) {
  ...
  let { connector, error = false, setPendingError, tryActivation } = _ref10
  const isMetamask =
    (_window = window) === null || _window === void 0
      ? void 0
      : (_window$ethereum = _window.ethereum) === null || _window$ethereum === void 0
      ? void 0
      : _window$ethereum.isMetaMask
  return /*#__PURE__*/ jsxs(PendingSection, {
    children: [
      /*#__PURE__*/ jsx(LoadingMessage, {
        error: error,
        children: /*#__PURE__*/ jsx(LoadingWrapper, {
          children: error
            ? /*#__PURE__*/ jsxs(ErrorGroup, {
                children: [
                  /*#__PURE__*/ jsx('div', {
                    children: /*#__PURE__*/ jsx(Trans, {
                      id: 'Error connecting',
...
const CloseIcon$1 = _styled.div.withConfig({
  displayName: 'WalletModal__CloseIcon',
  componentId: 'sc-1hmbv05-0',
})(['position:absolute;right:1rem;top:14px;&:hover{cursor:pointer;opacity:0.6;}'])

const CloseColor = _styled(SvgX).withConfig({
...
const Wrapper$c = _styled.div.withConfig({
...
const ContentWrapper$3 = _styled.div.withConfig({
  displayName: 'WalletModal__ContentWrapper',
  componentId: 'sc-1hmbv05-4',
})(
  [
    'background-color:',
    ';padding:0 1rem 1rem 1rem;border-bottom-left-radius:20px;border-bottom-right-radius:20px;',
    ';',
  ],
  (_ref6) => {
    let { theme } = _ref6
...
function WalletModal(_ref12) {
  let { pendingTransactions, confirmedTransactions, ENSName } = _ref12
  ...
  function getModalContent() {
    if (error) {
      return /*#__PURE__*/ jsxs(UpperSection, {
        children: [
          /*#__PURE__*/ jsx(CloseIcon$1, {
            onClick: toggleWalletModal,
            children: /*#__PURE__*/ jsx(CloseColor, {}),
          }),
    ...
    if (walletView === WALLET_VIEWS.LEGAL) {
      return /*#__PURE__*/ jsxs(UpperSection, {
        children: [
          /*#__PURE__*/ jsxs(HeaderRow, {
            children: [
              /*#__PURE__*/ jsx(HoverText, {
                onClick: () => {
                  var _ref13

                  setWalletView(
                    (_ref13 = previousWalletView === WALLET_VIEWS.LEGAL ? WALLET_VIEWS.ACCOUNT : previousWalletView) !==
                      null && _ref13 !== void 0
                      ? _ref13
              ...
              /*#__PURE__*/ jsx(Row, {
                justify: 'center',
                children: /*#__PURE__*/ jsx(ThemedText.MediumHeader, {
                  children: /*#__PURE__*/ jsx(Trans, {
                    id: 'Legal & Privacy',
                  }),
                }),
    ...
    if (account && walletView === WALLET_VIEWS.ACCOUNT) {
      return /*#__PURE__*/ jsx(AccountDetails, {
    ...
    return /*#__PURE__*/ jsxs(UpperSection, {
      children: [
        ...
        walletView !== WALLET_VIEWS.ACCOUNT
          ? /*#__PURE__*/ jsx(HeaderRow, {
              color: 'blue',
              children: /*#__PURE__*/ jsx(HoverText, {
                onClick: () => {
                  setPendingError(false)
                  setWalletView(WALLET_VIEWS.ACCOUNT)
                },
        ...
        /*#__PURE__*/ jsx(ContentWrapper$3, {
          children: /*#__PURE__*/ jsxs(AutoColumn, {
            gap: '16px',
            children: [
              /*#__PURE__*/ jsx(LightCard, {
                children: /*#__PURE__*/ jsx(AutoRow, {
                  style: {
                    flexWrap: 'nowrap',
                  },
                  children: /*#__PURE__*/ jsx(ThemedText.Black, {
                    fontSize: 14,
                    children: /*#__PURE__*/ jsx(Trans, {
                      ...
                      components: {
                        0: /*#__PURE__*/ jsx(ExternalLink, {
                          href: 'https://uniswap.org/terms-of-service/',
                        }),
                        1: /*#__PURE__*/ jsx(ExternalLink, {
                          href: 'https://uniswap.org/disclaimer/',
                        }),
                      },
                    }),
              ...
              walletView === WALLET_VIEWS.PENDING
                ? /*#__PURE__*/ jsx(PendingView, {
                    connector: pendingWallet,
                    error: pendingError,
                    setPendingError: setPendingError,
                    tryActivation: tryActivation,
                  })
                : /*#__PURE__*/ jsx(OptionGrid, {
                    children: getOptions(),
                  }),
            ],
          }),
  ...
  return /*#__PURE__*/ jsx(Modal, {
    ...
    minHeight: false,
    maxHeight: 90,
    children: /*#__PURE__*/ jsx(Wrapper$c, {
...
const Web3StatusConnected = _styled(Web3StatusGeneric).withConfig({
  ...
  [
    ...
    ';border:1px solid ',
    ';color:',
    ';font-weight:500;:hover,:focus{border:1px solid ',
    ';:focus{border:1px solid ',
    ';}}',
  ],
  (_ref19) => {
    let { pending, theme } = _ref19
    return pending ? theme.primary1 : theme.bg0
  },
  (_ref20) => {
    let { pending, theme } = _ref20
    return pending ? theme.primary1 : theme.bg1
  },
  (_ref21) => {
    let { pending, theme } = _ref21
...
function Web3StatusInner() {
  ...
  if (account) {
    return /*#__PURE__*/ jsxs(Web3StatusConnected, {
      ...
      children: [
        hasPendingTransactions
          ...
          : /*#__PURE__*/ jsxs(Fragment, {
              children: [
                hasSocks ? /*#__PURE__*/ jsx(Sock, {}) : null,
                /*#__PURE__*/ jsx(Text, {
        ...
        !hasPendingTransactions &&
          connector &&
          /*#__PURE__*/ jsx(WrappedStatusIcon, {
            connector: connector,
          }),
      ],
    })
  } else if (error) {
    return /*#__PURE__*/ jsxs(Web3StatusError, {
      onClick: toggleWalletModal,
      children: [
    ...
    return /*#__PURE__*/ jsx(Web3StatusConnect, {
      id: 'connect-wallet',
      onClick: toggleWalletModal,
      faded: !account,
...
async function addNetwork(_ref) {
  ...
  let { library, chainId, info } = _ref

  if (
    !(
      library !== null &&
      library !== void 0 &&
      (_library$provider = library.provider) !== null &&
      _library$provider !== void 0 &&
  ...
  try {
    await (library === null || library === void 0
      ? void 0
...
const ActiveRowLinkList = _styled.div.withConfig({
  ...
  [
    'display:flex;flex-direction:column;padding:0 8px;& > a{align-items:center;color:',
    ';display:flex;flex-direction:row;font-size:14px;font-weight:500;justify-content:space-between;padding:8px 0 4px;text-decoration:none;}& > a:first-child{border-top:1px solid ',
    ';margin:0;margin-top:6px;padding-top:10px;}',
  ],
  (_ref) => {
    let { theme } = _ref
    return theme.text2
...
const FlyoutMenu = _styled.div.withConfig({
  ...
  [
    ...
    ';box-shadow:0px 0px 1px rgba(0,0,0,0.01),0px 4px 8px rgba(0,0,0,0.04),0px 16px 24px rgba(0,0,0,0.04),0px 24px 32px rgba(0,0,0,0.01);border-radius:20px;display:flex;flex-direction:column;font-size:16px;overflow:auto;padding:16px;position:absolute;top:64px;width:272px;z-index:99;& > *:not(:last-child){margin-bottom:12px;}@media screen and (min-width:',
    'px){top:50px;}',
  ],
  (_ref5) => {
    let { theme } = _ref5
...
const FlyoutRow = _styled.div.withConfig({
  ...
  [
    ...
    ';border-radius:8px;cursor:pointer;display:flex;font-weight:500;justify-content:space-between;padding:6px 8px;text-align:left;width:100%;',
  ],
  (_ref6) => {
    let { active, theme } = _ref6
...
const SelectorControls = _styled.div.withConfig({
  ...
  [
    ...
    ';cursor:',
    ';display:flex;font-weight:500;justify-content:space-between;padding:6px 8px;',
  ],
  (_ref8) => {
    let { theme } = _ref8
    return theme.bg1
  ...
  (_ref11) => {
    let { interactive } = _ref11
    return interactive ? 'pointer' : 'auto'
  }
)

const SelectorLogo = _styled(Logo$1).withConfig({
  displayName: 'NetworkSelector__SelectorLogo',
  componentId: 'sc-w04zhs-11',
})(
  ['margin-right:', 'px;@media screen and (min-width:', 'px){margin-right:8px;}'],
  (_ref12) => {
    let { interactive } = _ref12
...
function NetworkSelector() {
  ...
  function Row(_ref15) {
    ...
    const RowContent = () =>
      /*#__PURE__*/ jsxs(FlyoutRow, {
        ...
        children: [
          ...
          /*#__PURE__*/ jsx(NetworkLabel, {
            children: rowText,
          }),
          chainId === targetChain && /*#__PURE__*/ jsx(FlyoutRowActiveIndicator, {}),
        ],
      })
    ...
    if (active && hasExtendedInfo) {
      return /*#__PURE__*/ jsxs(ActiveRowWrapper, {
        children: [
          /*#__PURE__*/ jsx(RowContent, {}),
          /*#__PURE__*/ jsxs(ActiveRowLinkList, {
            children: [
              /*#__PURE__*/ jsxs(ExternalLink, {
                href: CHAIN_INFO[targetChain].bridge,
                children: [
                  /*#__PURE__*/ jsx(BridgeText, {
                    chainId: chainId,
                  }),
                  ' ',
                  /*#__PURE__*/ jsx(LinkOutCircle$1, {}),
                ],
              }),
              /*#__PURE__*/ jsxs(ExternalLink, {
                href: CHAIN_INFO[targetChain].explorer,
                children: [
                  /*#__PURE__*/ jsx(ExplorerText, {
                    chainId: chainId,
                  }),
                  ' ',
                  /*#__PURE__*/ jsx(LinkOutCircle$1, {}),
    ...
    return /*#__PURE__*/ jsx(RowContent, {})
  }

  return /*#__PURE__*/ jsxs(SelectorWrapper, {
    ref: node,
    children: [
      /*#__PURE__*/ jsxs(SelectorControls, {
        onClick: conditionalToggle,
        interactive: showSelector,
        children: [
          /*#__PURE__*/ jsx(SelectorLogo, {
            interactive: showSelector,
            src: info.logoUrl || mainnetInfo.logoUrl,
          }),
          /*#__PURE__*/ jsx(SelectorLabel, {
            children: info.label,
          }),
          showSelector && /*#__PURE__*/ jsx(StyledChevronDown, {}),
        ],
      }),
      open &&
        /*#__PURE__*/ jsxs(FlyoutMenu, {
          children: [
            /*#__PURE__*/ jsx(FlyoutHeader, {
              children: /*#__PURE__*/ jsx(Trans, {
                id: 'Select a network',
              }),
            }),
...
function useTotalSupply(token) {
  ...
  const contract = useTokenContract(
    token !== null && token !== void 0 && token.isToken ? token.address : undefined,
    false
  )
  const totalSupply =
    (_useSingleCallResult = useSingleCallResult(contract, 'totalSupply')) === null || _useSingleCallResult === void 0
      ? void 0
      : (_useSingleCallResult$ = _useSingleCallResult.result) === null || _useSingleCallResult$ === void 0
      ? void 0
      : _useSingleCallResult$[0]
  return token !== null && token !== void 0 && token.isToken && totalSupply
...
const ContentWrapper$2 = _styled(AutoColumn).withConfig({
...
const StyledClose$2 = _styled(X).withConfig({
...
function UniBalanceContent(_ref) {
  ...
  let { setShowUniBalanceModal } = _ref
  const { account, chainId } = useActiveWeb3React()
  const uni = chainId ? UNI[chainId] : undefined
  ...
  const unclaimedUni = useTokenBalance(
    (_useMerkleDistributor = useMerkleDistributorContract()) === null || _useMerkleDistributor === void 0
      ? void 0
      : _useMerkleDistributor.address,
    uni
  )
  ...
  return /*#__PURE__*/ jsx(ContentWrapper$2, {
    gap: 'lg',
    children: /*#__PURE__*/ jsxs(ModalUpper, {
      children: [
        /*#__PURE__*/ jsx(CardBGImage, {}),
        /*#__PURE__*/ jsx(CardNoise, {}),
                    ...
                    children: [
                      /*#__PURE__*/ jsxs(RowBetween, {
                        children: [
                          ...
                          /*#__PURE__*/ jsx(ThemedText.White, {
                            color: 'white',
                            children:
                              uniBalance === null || uniBalance === void 0
                                ? void 0
                                : uniBalance.toFixed(2, {
                                    groupSeparator: ',',
                                  }),
                          }),
                        ],
                      ...
                      /*#__PURE__*/ jsxs(RowBetween, {
                        children: [
                          ...
                          /*#__PURE__*/ jsxs(ThemedText.White, {
                            color: 'white',
                            children: [
                              uniToClaim === null || uniToClaim === void 0
                                ? void 0
                                : uniToClaim.toFixed(4, {
                                    groupSeparator: ',',
                                  }),
                              ' ',
                              uniToClaim &&
                                uniToClaim.greaterThan('0') &&
                                /*#__PURE__*/ jsx(StyledInternalLink, {
                                  onClick: () => setShowUniBalanceModal(false),
                                  to: '/uni',
                                  children: /*#__PURE__*/ jsx(Trans, {
                                    id: '(claim)',
              ...
              /*#__PURE__*/ jsxs(RowBetween, {
                children: [
                  ...
                  /*#__PURE__*/ jsxs(ThemedText.White, {
                    ...
                    children: [
                      '$',
                      (_uniPrice$toFixed = uniPrice === null || uniPrice === void 0 ? void 0 : uniPrice.toFixed(2)) !==
                        null && _uniPrice$toFixed !== void 0
                        ? _uniPrice$toFixed
                        : '-',
                    ],
                  }),
              ...
              /*#__PURE__*/ jsxs(RowBetween, {
                children: [
                  ...
                  /*#__PURE__*/ jsx(ThemedText.White, {
                    color: 'white',
                    children:
                      circulation === null || circulation === void 0
                        ? void 0
              ...
              /*#__PURE__*/ jsxs(RowBetween, {
                children: [
                  ...
                  /*#__PURE__*/ jsx(ThemedText.White, {
                    color: 'white',
                    children:
                      totalSupply === null || totalSupply === void 0
                        ? void 0
...
const HeaderFrame = _styled.div.withConfig({
  ...
  [
    'display:grid;grid-template-columns:120px 1fr 120px;align-items:center;justify-content:space-between;align-items:center;flex-direction:row;width:100%;top:0;position:relative;padding:1rem;z-index:21;position:relative;background-image:',
    ';background-position:',
    ';background-size:100% 200%;box-shadow:0px 0px 0px 1px ',
    ';transition:background-position 0.1s,box-shadow 0.1s;background-blend-mode:hard-light;',
    ';',
    ';',
    ';',
  ],
  ...
  (_ref2) => {
    let { showBackground } = _ref2
    return showBackground ? '0 -100%' : '0 0'
  },
  (_ref3) => {
    let { theme, showBackground } = _ref3
...
const HeaderElement = _styled.div.withConfig({
  ...
  [
    'display:flex;align-items:center;&:not(:first-child){margin-left:0.5em;}& > *:not(:first-child){margin-left:8px;}',
    ';',
  ],
  (_ref7) => {
    let { theme } = _ref7
...
const HeaderLinks = _styled(Row).withConfig({
  ...
  [
    ...
    ';width:fit-content;padding:4px;border-radius:16px;display:grid;grid-auto-flow:column;grid-gap:10px;overflow:auto;align-items:center;',
    ';',
    ';',
    ';',
  ],
...
const AccountElement = _styled.div.withConfig({
  ...
  [
    'display:flex;flex-direction:row;align-items:center;background-color:',
    ';border-radius:12px;white-space:nowrap;width:100%;:focus{border:1px solid blue;}',
  ],
  (_ref14) => {
    let { theme, active } = _ref14
...
const UNIAmount = _styled(AccountElement).withConfig({
  ...
  [
    'color:white;padding:4px 8px;height:36px;font-weight:500;background-color:',
...
const BalanceText = _styled(Text$1).withConfig({
...
const Title = _styled.a.withConfig({
  ...
  [
    'display:flex;align-items:center;pointer-events:auto;justify-self:flex-start;margin-right:12px;',
...
const StyledNavLink = _styled(NavLink)
  .attrs({
    activeClassName,
  })
  .withConfig({
  ...
  [
    '',
    ' align-items:left;border-radius:3rem;outline:none;cursor:pointer;text-decoration:none;color:',
    ';font-size:1rem;font-weight:500;padding:8px 12px;word-break:break-word;overflow:hidden;white-space:nowrap;&.',
    '{border-radius:12px;font-weight:600;justify-content:center;color:',
    ';background-color:',
    ';}:hover,:focus{color:',
    ';}',
  ],
...
const StyledExternalLink = _styled(ExternalLink)
  .attrs({
    activeClassName,
  })
  .withConfig({
  ...
  [
    '',
    ' align-items:left;border-radius:3rem;outline:none;cursor:pointer;text-decoration:none;color:',
    ';font-size:1rem;width:fit-content;margin:0 12px;font-weight:500;&.',
    '{border-radius:12px;font-weight:600;color:',
    ';}:hover,:focus{color:',
...
function Header$2() {
  ...
  const userEthBalance =
    (_useETHBalances = useETHBalances(account ? [account] : [])) === null || _useETHBalances === void 0
      ? void 0
      : _useETHBalances[account !== null && account !== void 0 ? account : '']
  ...
  return /*#__PURE__*/ jsxs(HeaderFrame, {
    ...
    children: [
      ...
      /*#__PURE__*/ jsxs(HeaderLinks, {
        children: [
          /*#__PURE__*/ jsx(StyledNavLink, {
            id: `swap-nav-link`,
            to: '/swap',
            children: /*#__PURE__*/ jsx(Trans, {
              id: 'Swap',
          ...
          /*#__PURE__*/ jsxs(StyledExternalLink, {
            id: `charts-nav-link`,
            href: infoLink,
            children: [
              /*#__PURE__*/ jsx(Trans, {
      ...
      /*#__PURE__*/ jsxs(HeaderControls, {
        children: [
          /*#__PURE__*/ jsx(HeaderElement, {
            children: /*#__PURE__*/ jsx(NetworkSelector, {}),
          }),
          /*#__PURE__*/ jsxs(HeaderElement, {
            children: [
              availableClaim &&
                !showClaimPopup &&
                /*#__PURE__*/ jsxs(UNIWrapper, {
                  onClick: toggleClaimModal,
                  children: [
                    /*#__PURE__*/ jsx(UNIAmount, {
                      active: !!account && !availableClaim,
                      style: {
                        pointerEvents: 'auto',
                      },
                      children: /*#__PURE__*/ jsx(ThemedText.White, {
                        padding: '0 2px',
                        children:
                          claimTxn && !(claimTxn !== null && claimTxn !== void 0 && claimTxn.receipt)
                            ? /*#__PURE__*/ jsx(Dots, {
                                children: /*#__PURE__*/ jsx(Trans, {
                                  id: 'Claiming UNI',
                                }),
              ...
              /*#__PURE__*/ jsxs(AccountElement, {
                active: !!account,
                children: [
                  account && userEthBalance
                    ? /*#__PURE__*/ jsx(BalanceText, {
                        style: {
                          flexShrink: 0,
                          userSelect: 'none',
                        },
                        ...
                        children: /*#__PURE__*/ jsx(Trans, {
                          ...
                          values: {
                            0:
                              userEthBalance === null || userEthBalance === void 0
                                ? void 0
...
const Wrapper$b = _styled.div.withConfig({
  displayName: 'ChainConnectivityWarning__Wrapper',
  componentId: 'sc-zncp67-5',
})(
  [
    'background-color:',
    ';border-radius:12px;bottom:60px;display:none;max-width:348px;padding:16px 20px;position:absolute;right:16px;@media screen and (min-width:',
    'px){display:block;}',
  ],
  (_ref4) => {
    let { theme } = _ref4
  ...
  return /*#__PURE__*/ jsxs(Wrapper$b, {
    children: [
      /*#__PURE__*/ jsxs(TitleRow, {
        children: [
          /*#__PURE__*/ jsx(CautionIcon, {}),
          /*#__PURE__*/ jsx(TitleText, {
            children: /*#__PURE__*/ jsx(Trans, {
              id: 'Network Warning',
            }),
          }),
...
const StyledPolling = _styled.div.withConfig({
  ...
  [
    'position:fixed;display:flex;align-items:center;right:0;bottom:0;padding:1rem;color:',
    ';transition:250ms ease color;',
    '',
  ],
  (_ref) => {
    let { theme, warning } = _ref
...
const StyledPollingDot = _styled.div.withConfig({
  ...
  [
    'width:8px;height:8px;min-height:8px;min-width:8px;border-radius:50%;position:relative;background-color:',
    ';transition:250ms ease background-color;',
  ],
  (_ref4) => {
    let { theme, warning } = _ref4
    return warning ? theme.yellow3 : theme.green1
  }
)
...
const Spinner = _styled.div.withConfig({
  ...
  [
    'animation:',
    ' 1s cubic-bezier(0.83,0,0.17,1) infinite;transform:translateZ(0);border-top:1px solid transparent;border-right:1px solid transparent;border-bottom:1px solid transparent;border-left:2px solid ',
    ';background:transparent;width:14px;height:14px;border-radius:50%;position:relative;transition:250ms ease border-color;left:-3px;top:-3px;',
  ],
  rotate360,
  (_ref5) => {
    let { theme, warning } = _ref5
    return warning ? theme.yellow3 : theme.green1
  }
)
...
function Polling() {
  ...
  const waitMsBeforeWarning =
    (_ref6 = chainId
      ? (_CHAIN_INFO$chainId = CHAIN_INFO[chainId]) === null || _CHAIN_INFO$chainId === void 0
        ? void 0
        : _CHAIN_INFO$chainId.blockWaitMsBeforeWarning
      : DEFAULT_MS_BEFORE_WARNING) !== null && _ref6 !== void 0
      ? _ref6
  ...
  return /*#__PURE__*/ jsxs(Fragment, {
    children: [
      /*#__PURE__*/ jsx(ExternalLink, {
        ...
        children: /*#__PURE__*/ jsxs(StyledPolling, {
          onMouseEnter: () => setIsHover(true),
          onMouseLeave: () => setIsHover(false),
          warning: warning,
          children: [
            /*#__PURE__*/ jsxs(StyledPollingNumber, {
              breathe: isMounting,
              hovering: isHover,
              children: [blockNumber, '\u2002'],
            }),
            /*#__PURE__*/ jsx(StyledPollingDot, {
              warning: warning,
              children:
                isMounting &&
      ...
      warning && /*#__PURE__*/ jsx(ChainConnectivityWarning, {}),
    ],
  })
}
...
const StyledClose$1 = _styled(X).withConfig({
...
function ClaimPopup() {
  ...
  const { account } = useActiveWeb3React() // dont store these in persisted state yet
  ...
  return /*#__PURE__*/ jsx(Fragment, {
    children:
      showClaimPopup &&
      !showClaimModal &&
      /*#__PURE__*/ jsxs(StyledClaimPopup, {
        gap: 'md',
        children: [
          /*#__PURE__*/ jsx(CardBGImage, {}),
          /*#__PURE__*/ jsx(CardNoise, {}),
          /*#__PURE__*/ jsx(StyledClose$1, {
            stroke: 'white',
          ...
          /*#__PURE__*/ jsx(AutoColumn, {
            style: {
              zIndex: 10,
            },
            justify: 'center',
            children: /*#__PURE__*/ jsx(ButtonPrimary, {
              padding: '8px',
              $borderRadius: '8px',
              width: 'fit-content',
...
function TransactionPopup(_ref) {
  ...
  return /*#__PURE__*/ jsxs(RowNoFlex, {
    children: [
      /*#__PURE__*/ jsx('div', {
        style: {
          paddingRight: 16,
      ...
      /*#__PURE__*/ jsxs(AutoColumn, {
        ...
        children: [
          /*#__PURE__*/ jsx(ThemedText.Body, {
            fontWeight: 500,
            children: /*#__PURE__*/ jsx(TransactionSummary, {
              info: tx.info,
            }),
          }),
          chainId &&
...
const Popup = _styled.div.withConfig({
  ...
  [
    'display:inline-block;width:100%;padding:1em;background-color:',
    ';position:relative;border-radius:10px;padding:20px;padding-right:35px;overflow:hidden;',
    '',
  ],
  (_ref) => {
    let { theme } = _ref
...
function PopupItem(_ref4) {
  let { removeAfterMs, content, popKey } = _ref4
  ...
  if ('txn' in content) {
    ...
    popupContent = /*#__PURE__*/ jsx(TransactionPopup, {
      hash: hash,
    })
  }
...
const MobilePopupWrapper = _styled.div.withConfig({
  ...
  ['position:relative;max-width:100%;height:', ';margin:', ';margin-bottom:', '};display:none;', ';'],
  (_ref) => {
    let { height } = _ref
    return height
  },
...
const FixedPopupColumn = _styled(AutoColumn).withConfig({
  ...
  ['position:fixed;top:', ';right:1rem;max-width:355px !important;width:100%;z-index:3;', ';', '{top:', ';}'],
  (_ref5) => {
    let { extraPadding } = _ref5
  ...
  StopOverflowQuery,
  (_ref7) => {
    let { extraPadding, xlPadding } = _ref7
...
function Popups() {
  ...
  return /*#__PURE__*/ jsxs(Fragment, {
    children: [
      /*#__PURE__*/ jsxs(FixedPopupColumn, {
        gap: '20px',
        extraPadding: urlWarningActive,
        xlPadding: isNotOnMainnet,
        children: [
          /*#__PURE__*/ jsx(ClaimPopup, {}),
      ...
      /*#__PURE__*/ jsx(MobilePopupWrapper, {
        height:
          (activePopups === null || activePopups === void 0 ? void 0 : activePopups.length) > 0 ? 'fit-content' : 0,
        children: /*#__PURE__*/ jsx(MobilePopupInner, {
...
function Web3ReactManager(_ref2) {
  ...
  const { active: networkActive, error: networkError, activate: activateNetwork } = useWeb3React(NetworkContextName) // try to eagerly connect to an injected provider, if it exists and has granted access already
...
const BetaTag = _styled.span.withConfig({
  ...
  [
    ...
    ';display:flex;font-size:14px;height:28px;justify-content:center;left:-16px;position:absolute;transform:rotate(-15deg);top:-16px;width:60px;z-index:1;',
  ],
  (_ref) => {
    let { color } = _ref
    return color
...
const Body = _styled.p.withConfig({
  ...
  [
    'font-size:12px;grid-column:1 / 3;line-height:143%;margin:0;@media screen and (min-width:',
    'px){grid-column:2 / 3;}',
  ],
  MEDIA_WIDTHS.upToSmall
)

const Controls = _styled.div.withConfig({
...
const BodyText = _styled.div.withConfig({
  ...
  [
    'align-items:center;display:grid;grid-gap:4px;grid-template-columns:40px 4fr;grid-template-rows:auto auto;margin:20px 16px;@media screen and (min-width:',
    'px){grid-template-columns:42px 4fr;grid-gap:8px;}',
  ],
  MEDIA_WIDTHS.upToSmall
)
...
const LearnMoreLink = _styled(ExternalLink).withConfig({
  ...
  [
    'align-items:center;background-color:transparent;border:1px solid rgba(255,255,255,0.4);border-radius:8px;color:',
    ';display:flex;font-size:16px;height:44px;justify-content:space-between;margin:0 0 20px 0;padding:12px 16px;text-decoration:none;width:auto;:hover,:focus,:active{background-color:rgba(255,255,255,0.05);}transition:background-color 150ms ease-in-out;',
    '',
  ],
  (_ref4) => {
    let { theme } = _ref4
...
const ContentWrapper$1 = _styled.div.withConfig({
  displayName: 'NetworkAlert__ContentWrapper',
  componentId: 'sc-17mb1wp-9',
})(
  [
    '',
    ';border-radius:20px;display:flex;flex-direction:column;max-width:480px;min-height:174px;overflow:hidden;position:relative;width:100%;',
    ':before{background-image:url(',
    ");background-repeat:no-repeat;background-size:300px;content:'';height:300px;opacity:0.1;position:absolute;transform:rotate(25deg) translate(-90px,-40px);width:300px;z-index:-1;}",
  ],
  (_ref6) => {
    let { chainId, darkMode } = _ref6
    return [SupportedChainId.OPTIMISM, SupportedChainId.OPTIMISTIC_KOVAN].includes(chainId)
      ? darkMode
...
const Header$1 = _styled.h2.withConfig({
...
const LinkOutToBridge = _styled(ExternalLink).withConfig({
  ...
  [
    'align-items:center;background-color:black;border-radius:8px;color:white;display:flex;font-size:16px;height:44px;justify-content:space-between;margin:0 12px 20px 18px;padding:12px 16px;text-decoration:none;width:auto;:hover,:focus,:active{background-color:black;}',
    '',
  ],
  (_ref10) => {
    let { thin } = _ref10
...
function NetworkAlert(props) {
  ...
  const showCloseIcon = Boolean(
    (userEthBalance === null || userEthBalance === void 0 ? void 0 : userEthBalance.greaterThan(0)) && !props.thin
  )
  return /*#__PURE__*/ jsxs(RootWrapper, {
    children: [
      /*#__PURE__*/ jsx(BetaTag, {
        color: isOptimism ? '#ff0420' : '#0490ed',
        children: 'Beta',
      }),
      /*#__PURE__*/ jsxs(ContentWrapper$1, {
        chainId: chainId,
        darkMode: darkMode,
        ...
        children: [
          ...
          /*#__PURE__*/ jsxs(Controls, {
            thin: props.thin,
            children: [
              /*#__PURE__*/ jsxs(LinkOutToBridge, {
                href: depositUrl,
                thin: props.thin,
                children: [
                  /*#__PURE__*/ jsx(Trans, {
                  ...
                  /*#__PURE__*/ jsx(LinkOutCircle, {}),
                ],
              }),
              /*#__PURE__*/ jsx(LearnMoreLink, {
                href: helpCenterLink,
                thin: props.thin,
                children: /*#__PURE__*/ jsx(Trans, {
                  id: 'Learn More',
      ...
      const routeRealizedLPFeePercent = overallPercent.multiply(
        ONE_HUNDRED_PERCENT.subtract(
          swap.route.pools.reduce(
            (currentFee, pool) => currentFee.multiply(ONE_HUNDRED_PERCENT.subtract(new Fraction(pool.fee, 1000000))),
            ONE_HUNDRED_PERCENT
          )
        )
      )
...
function TextWithLoadingPlaceholder(_ref) {
  let { syncing, width, children } = _ref
  return syncing
    ? /*#__PURE__*/ jsx(LoadingRows, {
        children: /*#__PURE__*/ jsx('div', {
          style: {
            height: '15px',
            width: `${width}px`,
...
function AdvancedSwapDetails(_ref2) {
  let { trade, allowedSlippage, syncing = false } = _ref2
  const theme = useContext(ThemeContext)
  ...
  return !trade
    ...
    : /*#__PURE__*/ jsxs(AutoColumn, {
        gap: '8px',
        children: [
          /*#__PURE__*/ jsx(TransactionDetailsLabel, {
            fontWeight: 500,
            fontSize: 14,
            children: /*#__PURE__*/ jsx(Trans, {
          ...
          /*#__PURE__*/ jsxs(RowBetween, {
            children: [
              ...
              /*#__PURE__*/ jsx(TextWithLoadingPlaceholder, {
                syncing: syncing,
                width: 65,
                children: /*#__PURE__*/ jsx(ThemedText.Black, {
                  textAlign: 'right',
            ...
            children: [
              ...
              /*#__PURE__*/ jsx(TextWithLoadingPlaceholder, {
                ...
                children: /*#__PURE__*/ jsx(ThemedText.Black, {
                  textAlign: 'right',
                  fontSize: 14,
                  children: /*#__PURE__*/ jsx(FormattedPriceImpact, {
          ...
          /*#__PURE__*/ jsxs(RowBetween, {
            children: [
              ...
              /*#__PURE__*/ jsx(TextWithLoadingPlaceholder, {
                syncing: syncing,
                width: 45,
                children: /*#__PURE__*/ jsxs(ThemedText.Black, {
                  textAlign: 'right',
                  fontSize: 14,
...
const StyledAutoRouterIcon = _styled(SvgAutoRouter).withConfig({
  displayName: 'RouterLabel__StyledAutoRouterIcon',
  componentId: 'sc-1uzj9pr-0',
})(['height:16px;width:16px;:hover{filter:brightness(1.3);}'])

const StyledStaticRouterIcon = _styled(SvgStaticRoute).withConfig({
...
function AutoRouterLogo() {
  const routingAPIEnabled = useRoutingAPIEnabled()
  return routingAPIEnabled ? /*#__PURE__*/ jsx(StyledAutoRouterIcon, {}) : /*#__PURE__*/ jsx(StyledStaticRouterIcon, {})
}
function AutoRouterLabel() {
  const routingAPIEnabled = useRoutingAPIEnabled()
  return routingAPIEnabled
    ? /*#__PURE__*/ jsx(StyledAutoRouterLabel, {
        fontSize: 14,
...
const Badge = _styled.div.withConfig({
  ...
  [
    'align-items:center;background-color:',
    ';border:',
    ';border-radius:0.5rem;color:',
    ';display:inline-flex;padding:4px 6px;justify-content:center;font-weight:500;',
  ],
  (_ref) => {
    let { theme, variant } = _ref
    return pickBackgroundColor(variant, theme)
  },
  (_ref2) => {
    let { theme, variant } = _ref2
    return pickBorder(variant, theme)
  },
  (_ref3) => {
    let { theme, variant } = _ref3
...
function useENSContentHash(ensName) {
  ...
  const resolverAddress =
    (_resolverAddressResul = resolverAddressResult.result) === null || _resolverAddressResul === void 0
      ? void 0
      : _resolverAddressResul[0]
  const resolverContract = useENSResolverContract(
  ...
  return useMemo(() => {
    ...
    return {
      contenthash:
        (_contenthash$result$ =
          (_contenthash$result = contenthash.result) === null || _contenthash$result === void 0
            ? void 0
            : _contenthash$result[0]) !== null && _contenthash$result$ !== void 0
          ? _contenthash$result$
          : null,
...
function Logo(_ref) {
  ...
  return /*#__PURE__*/ jsx(Slash, { ...rest, style: { ...style, color: theme.bg4 } })
}
...
const StyledEthereumLogo = _styled.img.withConfig({
  ...
  ['width:', ';height:', ';box-shadow:0px 6px 10px rgba(0,0,0,0.075);border-radius:24px;'],
  (_ref) => {
    let { size } = _ref
    return size
  },
...
const StyledLogo$1 = _styled(Logo).withConfig({
  displayName: 'CurrencyLogo__StyledLogo',
  componentId: 'sc-1fvnadz-1',
})(
  ['width:', ';height:', ';border-radius:', ';box-shadow:0px 6px 10px rgba(0,0,0,0.075);background-color:', ';'],
  (_ref3) => {
    let { size } = _ref3
    return size
  },
...
function CurrencyLogo(_ref7) {
  ...
  let { currency, size = '24px', style, ...rest } = _ref7
  ...
  if (currency !== null && currency !== void 0 && currency.isNative) {
    return /*#__PURE__*/ jsx(StyledEthereumLogo, {
      src: EthereumLogo,
      alt: 'ethereum logo',
      size: size,
      style: style,
  ...
  return /*#__PURE__*/ jsx(StyledLogo$1, {
    size: size,
    srcs: srcs,
    alt: `${
      (_currency$symbol = currency === null || currency === void 0 ? void 0 : currency.symbol) !== null &&
      _currency$symbol !== void 0
        ? _currency$symbol
        : 'token'
    } logo`,
    style: style,
...
function DoubleCurrencyLogo(_ref3) {
  let { currency0, currency1, size = 16, margin = false } = _ref3
  return /*#__PURE__*/ jsxs(Wrapper$a, {
    sizeraw: size,
    margin: margin,
    children: [
      currency0 &&
        /*#__PURE__*/ jsx(HigherLogo, {
          currency: currency0,
          size: size.toString() + 'px',
        }),
      currency1 &&
        /*#__PURE__*/ jsx(CoveredLogo, {
          currency: currency1,
          size: size.toString() + 'px',
          sizeraw: size,
        }),
...
const SvgDotLine = (props) =>
  /*#__PURE__*/ React.createElement(
    ...
    _line ||
      (_line = /*#__PURE__*/ React.createElement('line', {
        x1: 0,
        x2: 2000,
        y1: 100,
        y2: 100,
...
const Wrapper$9 = _styled(Box$1).withConfig({
...
const DotColor = _styled(SvgDotLine).withConfig({
...
function RoutingDiagram(_ref4) {
  let { currencyIn, currencyOut, routes } = _ref4
  ...
  return /*#__PURE__*/ jsx(Wrapper$9, {
    children: routes.map((_ref5, index) => {
      let { percent, path } = _ref5
      return /*#__PURE__*/ jsxs(
        RouteContainerRow,
        {
          children: [
            /*#__PURE__*/ jsx(CurrencyLogo, {
              currency: tokenIn,
            }),
            /*#__PURE__*/ jsx(Route, {
              percent: percent,
...
function Route(_ref6) {
  let { percent, path } = _ref6
  return /*#__PURE__*/ jsxs(RouteRow, {
    children: [
      /*#__PURE__*/ jsx(DottedLine, {
        children: /*#__PURE__*/ jsx(DotColor, {}),
      }),
      /*#__PURE__*/ jsx(OpaqueBadge, {
        children: /*#__PURE__*/ jsxs(ThemedText.Small, {
          fontSize: 12,
          style: {
            wordBreak: 'normal',
          },
...
function getTradeVersion(trade) {
  ...
  if (trade instanceof Trade) return Version.v2
  return Version.v3
}

const Separator$1 = _styled.div.withConfig({
...
var SwapRoute = /*#__PURE__*/ memo(function SwapRoute(_ref2) {
  let { trade, syncing } = _ref2
  const routingAPIEnabled = useRoutingAPIEnabled()
  return /*#__PURE__*/ jsxs(AutoColumn, {
    gap: '12px',
    children: [
      /*#__PURE__*/ jsxs(RowBetween, {
        children: [
          /*#__PURE__*/ jsxs(AutoRow, {
            gap: '4px',
            width: 'auto',
            children: [/*#__PURE__*/ jsx(AutoRouterLogo, {}), /*#__PURE__*/ jsx(AutoRouterLabel, {})],
          }),
          syncing
            ? /*#__PURE__*/ jsx(LoadingRows, {
                children: /*#__PURE__*/ jsx('div', {
            ...
            : /*#__PURE__*/ jsx(Badge, {
                children: /*#__PURE__*/ jsx(ThemedText.Black, {
                  fontSize: 12,
                  children:
                    getTradeVersion(trade) === Version.v2
                      ? /*#__PURE__*/ jsx(Trans, {
                          id: 'V2',
                        })
                      : /*#__PURE__*/ jsx(Trans, {
...
const DetailsFooter = _styled.div.withConfig({
  ...
  [
    'padding-top:calc(16px + 2rem);padding-bottom:20px;margin-left:auto;margin-right:auto;margin-top:-2rem;width:100%;max-width:400px;border-bottom-left-radius:20px;border-bottom-right-radius:20px;color:',
    ';background-color:',
    ';z-index:',
    ';transform:',
    ';transition:transform 300ms ease-in-out;text-align:center;',
  ],
  (_ref) => {
    let { theme } = _ref
    return theme.text2
...
const AddressText$1 = _styled(ThemedText.Blue).withConfig({
...
function UnsupportedCurrencyFooter(_ref5) {
  ...
  return /*#__PURE__*/ jsxs(DetailsFooter, {
    show: show,
    children: [
      /*#__PURE__*/ jsx(Modal, {
        isOpen: showDetails,
              ...
              tokens.map((token) => {
                ...
                return (
                  ...
                  /*#__PURE__*/ jsx(
                        ...
                        children: [
                          ...
                          chainId &&
                            /*#__PURE__*/ jsx(ExternalLink, {
                              ...
                              children: /*#__PURE__*/ jsx(AddressText$1, {
                    ...
                    (_token$address = token.address) === null || _token$address === void 0
                      ? void 0
                      : _token$address.concat('not-supported')
                  )
                )
              }),
              /*#__PURE__*/ jsx(AutoColumn, {
      ...
      /*#__PURE__*/ jsx(StyledButtonEmpty, {
        padding: '0',
        onClick: () => setShowDetails(true),
        children: /*#__PURE__*/ jsx(ThemedText.Blue, {
          children: /*#__PURE__*/ jsx(Trans, {
...
const StyledInput = _styled.input.withConfig({
  ...
  [
    'color:',
    ';width:0;position:relative;font-weight:500;outline:none;border:none;flex:1 1 auto;background-color:',
    ';font-size:',
    ';text-align:',
    ";white-space:nowrap;overflow:hidden;text-overflow:ellipsis;padding:0px;-webkit-appearance:textfield;text-align:right;::-webkit-search-decoration{-webkit-appearance:none;}[type='number']{-moz-appearance:textfield;}::-webkit-outer-spin-button,::-webkit-inner-spin-button{-webkit-appearance:none;}::placeholder{color:",
    ';}',
  ],
  (_ref) => {
    let { error, theme } = _ref
    return error ? theme.red1 : theme.text1
  },
  (_ref2) => {
    let { theme } = _ref2
...
const Input$1 = /*#__PURE__*/ React__default.memo(function InnerInput(_ref6) {
  let { value, onUserInput, placeholder, prependSymbol, ...rest } = _ref6
    ...
    onChange: (event) => {
      if (prependSymbol) {
        ...
        const formattedValue = value.toString().includes(prependSymbol)
          ...
          : value // replace commas with periods, because uniswap exclusively uses period as the decimal separator
...
const QuestionWrapper = _styled.div.withConfig({
  ...
  [
    'display:flex;align-items:center;justify-content:center;padding:0px;width:18px;height:18px;border:none;background:none;outline:none;cursor:default;border-radius:36px;font-size:12px;background-color:',
    ';color:',
...
function QuestionHelper(_ref3) {
  ...
  return /*#__PURE__*/ jsx('span', {
    ...
    children: /*#__PURE__*/ jsx(Tooltip, {
      text: text,
      show: show,
      children: /*#__PURE__*/ jsx(QuestionWrapper, {
        onClick: open,
        onMouseEnter: open,
        onMouseLeave: close,
        children: /*#__PURE__*/ jsx(QuestionMark, {
          children: '?',
        }),
      }),
    }),
...
const BaseWrapper = _styled.div.withConfig({
  ...
  [
    'border:1px solid ',
    ';border-radius:10px;display:flex;padding:6px;align-items:center;:hover{cursor:',
    ';background-color:',
    ';}color:',
    ';background-color:',
    ';filter:',
  ...
  (_ref4) => {
    let { theme, disable } = _ref4
    return !disable && theme.bg2
  },
  (_ref5) => {
    let { theme, disable } = _ref5
    return disable && theme.text3
  },
  (_ref6) => {
    let { theme, disable } = _ref6
...
function CommonBases(_ref8) {
  ...
  let { chainId, onSelect, selectedCurrency } = _ref8
  const bases =
    typeof chainId !== 'undefined'
      ? (_COMMON_BASES$chainId = COMMON_BASES[chainId]) !== null && _COMMON_BASES$chainId !== void 0
        ? _COMMON_BASES$chainId
        : []
      : []
  return bases.length > 0
    ? /*#__PURE__*/ jsxs(MobileWrapper, {
        gap: 'md',
        children: [
          /*#__PURE__*/ jsxs(AutoRow, {
            children: [
              ...
              /*#__PURE__*/ jsx(QuestionHelper, {
                text: /*#__PURE__*/ jsx(Trans, {
          ...
          /*#__PURE__*/ jsx(AutoRow, {
            ...
            children: bases.map((currency) => {
              const isSelected =
                selectedCurrency === null || selectedCurrency === void 0 ? void 0 : selectedCurrency.equals(currency)
              return /*#__PURE__*/ jsxs(
                BaseWrapper,
                {
                  ...
                  disable: isSelected,
                  children: [
                    /*#__PURE__*/ jsx(CurrencyLogoFromList, {
                      currency: currency,
                    }),
                    /*#__PURE__*/ jsx(Text$1, {
                      fontWeight: 500,
...
function CurrencyLogoFromList(_ref9) {
  ...
  return /*#__PURE__*/ jsx(CurrencyLogo, {
    currency: token,
    style: {
      marginRight: 8,
    },
...
function ListLogo(_ref3) {
  let { logoURI, style, size = '24px', alt } = _ref3
  const srcs = useHttpLocations(logoURI)
  return /*#__PURE__*/ jsx(StyledListLogo, {
    alt: alt,
    size: size,
    srcs: srcs,
    style: style,
    ...
    children: [
      ...
      /*#__PURE__*/ jsxs(AutoColumn, {
        ...
        children: [
          /*#__PURE__*/ jsxs(AutoRow, {
            children: [
              ...
              /*#__PURE__*/ jsx(ThemedText.DarkGray, {
                ml: '8px',
                fontWeight: 300,
                children: /*#__PURE__*/ jsx(NameOverflow, {
                  title: token.name,
                  children: token.name,
                }),
              }),
          ...
          list &&
            list.logoURI &&
            /*#__PURE__*/ jsxs(RowFixed, {
              children: [
                /*#__PURE__*/ jsx(ThemedText.Small, {
                  mr: '4px',
                  color: theme.text3,
                  children: /*#__PURE__*/ jsx(Trans, {
                    id: 'via {0}',
...
const TextDot = _styled.div.withConfig({
...
const Checkbox = _styled.input.withConfig({
...
const PaddedColumn = _styled(AutoColumn).withConfig({
  displayName: 'styleds__PaddedColumn',
  componentId: 'sc-1xp9ndq-2',
})(['padding:20px;'])
const MenuItem = _styled(RowBetween).withConfig({
  displayName: 'styleds__MenuItem',
  componentId: 'sc-1xp9ndq-3',
})(
  [
    'padding:4px 20px;height:56px;display:grid;grid-template-columns:auto minmax(auto,1fr) auto minmax(0,72px);grid-gap:16px;cursor:',
    ';pointer-events:',
    ';:hover{background-color:',
    ';}opacity:',
    ';',
  ...
  (_ref5) => {
    let { theme, disabled } = _ref5
    return !disabled && theme.bg2
  },
  (_ref6) => {
    let { disabled, selected } = _ref6
...
const SearchInput = _styled.input.withConfig({
  ...
  [
    'position:relative;display:flex;padding:16px;align-items:center;width:100%;white-space:nowrap;background:none;border:none;outline:none;border-radius:20px;color:',
    ';border-style:solid;border:1px solid ',
    ';-webkit-appearance:none;font-size:18px;::placeholder{color:',
    ';}transition:border 100ms;:focus{border:1px solid ',
    ';outline:none;}',
  ],
  (_ref7) => {
    let { theme } = _ref7
...
const SeparatorDark = _styled.div.withConfig({
...
const StyledBalanceText = _styled(Text$1).withConfig({
...
const Tag = _styled.div.withConfig({
  ...
  [
    'background-color:',
    ';color:',
    ';font-size:14px;border-radius:4px;padding:0.25rem 0.3rem 0.25rem 0.3rem;max-width:6rem;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;justify-self:flex-end;margin-right:4px;',
  ],
  (_ref) => {
    let { theme } = _ref
    return theme.bg3
...
function Balance(_ref3) {
  let { balance } = _ref3
  return /*#__PURE__*/ jsx(StyledBalanceText, {
...
function TokenTags(_ref4) {
  ...
  if (!tags || tags.length === 0) return /*#__PURE__*/ jsx('span', {})
  const tag = tags[0]
  return /*#__PURE__*/ jsxs(TagContainer, {
    children: [
      /*#__PURE__*/ jsx(MouseoverTooltip, {
...
function CurrencyRow(_ref6) {
  let { currency, onSelect, isSelected, otherSelected, style, showCurrencyAmount } = _ref6
  const { account } = useActiveWeb3React()
...
function BreakLineComponent(_ref7) {
  let { style } = _ref7
  const theme = useTheme()
  return /*#__PURE__*/ jsx(FixedContentRow, {
    style: style,
    children: /*#__PURE__*/ jsx(LightGreyCard, {
      padding: '8px 12px',
      $borderRadius: '8px',
      children: /*#__PURE__*/ jsxs(RowBetween, {
        children: [
          /*#__PURE__*/ jsxs(RowFixed, {
            children: [
              /*#__PURE__*/ jsx(TokenListLogoWrapper, {
                src: TokenListLogo,
              }),
              /*#__PURE__*/ jsx(ThemedText.Main, {
                ml: '6px',
...
function CurrencyList(_ref8) {
  ...
  const itemData = useMemo(() => {
    if (
      otherListTokens &&
      (otherListTokens === null || otherListTokens === void 0 ? void 0 : otherListTokens.length) > 0
    ) {
  ...
  const Row = useCallback(
    function TokenRow(_ref9) {
      let { data, index, style } = _ref9
      const row = data[index]

      if (isBreakLine(row)) {
        return /*#__PURE__*/ jsx(BreakLineComponent, {
          style: style,
        })
      }
      ...
      if (showImport && token) {
        ...
        return /*#__PURE__*/ jsx(CurrencyRow, {
          style: style,
          currency: currency,
...
function useTokenComparator(inverted) {
  ...
  const comparator = useMemo(
    () => getTokenComparator(balances !== null && balances !== void 0 ? balances : {}),
    [balances]
  )
  return useMemo(() => {
    if (inverted) {
...
const Footer$1 = _styled.div.withConfig({
  displayName: 'CurrencySearch__Footer',
  componentId: 'sc-1it7zu4-1',
})(
  [
    'width:100%;border-radius:20px;padding:20px;border-top-left-radius:0;border-top-right-radius:0;background-color:',
...
function CurrencySearch(_ref3) {
  ...
  const handleInput = useCallback((event) => {
    ...
    ;(_fixedList$current = fixedList.current) === null || _fixedList$current === void 0
      ? void 0
      : _fixedList$current.scrollTo(0)
  }, [])
    ...
    (e) => {
      if (e.key === 'Enter') {
        ...
        if (s === 'eth' && ether) {
          ...
          if (
            ((_filteredSortedTokens = filteredSortedTokensWithETH[0].symbol) === null ||
            _filteredSortedTokens === void 0
              ? void 0
              : _filteredSortedTokens.toLowerCase()) === debouncedQuery.trim().toLowerCase() ||
    ...
    children: [
      ...
      searchToken && !searchTokenIsAdded
        ? /*#__PURE__*/ jsx(Column, {
            ...
            children: /*#__PURE__*/ jsx(ImportRow, {
              token: searchToken,
              showImportView: showImportView,
              setImportToken: setImportToken,
            }),
          })
        : (filteredSortedTokens === null || filteredSortedTokens === void 0 ? void 0 : filteredSortedTokens.length) >
            0 ||
          (filteredInactiveTokens === null || filteredInactiveTokens === void 0
            ? void 0
        ...
        ? /*#__PURE__*/ jsx('div', {
            ...
            children: /*#__PURE__*/ jsx(AutoSizer, {
              ...
              children: (_ref4) => {
                let { height } = _ref4
                return /*#__PURE__*/ jsx(CurrencyList, {
                  height: height,
      ...
      /*#__PURE__*/ jsx(Footer$1, {
        children: /*#__PURE__*/ jsx(Row, {
          ...
          children: /*#__PURE__*/ jsx(ButtonText, {
            ...
            children: /*#__PURE__*/ jsxs(RowFixed, {
              children: [
                /*#__PURE__*/ jsx(IconWrapper$4, {
                  size: '16px',
                  marginRight: '6px',
...
async function getTokenList(listUrl, resolveENSContentHash) {
  ...
  if (parsedENS) {
    ...
    urls = uriToHttp(
      `${translatedUri}${
        (_parsedENS$ensPath = parsedENS.ensPath) !== null && _parsedENS$ensPath !== void 0 ? _parsedENS$ensPath : ''
      }`
    )
  } else {
  ...
  for (let i = 0; i < urls.length; i++) {
    ...
    if (!validator(json)) {
      ...
      const validationErrors =
        (_validator$errors$red =
          (_validator$errors = validator.errors) === null || _validator$errors === void 0
            ? void 0
            : _validator$errors.reduce((memo, error) => {
                var _error$message

                const add = `${error.dataPath} ${
                  (_error$message = error.message) !== null && _error$message !== void 0 ? _error$message : ''
                }`
                return memo.length > 0 ? `${memo}; ${add}` : `${add}`
              }, '')) !== null && _validator$errors$red !== void 0
          ? _validator$errors$red
          : 'unknown error'
...
const Wrapper$8 = _styled.div.withConfig({
...
function ImportList(_ref) {
  ...
  let { listURL, list, setModalView, onDismiss } = _ref
  const theme = useTheme()
  ...
  const adding = Boolean(
    (_lists$listURL = lists[listURL]) === null || _lists$listURL === void 0 ? void 0 : _lists$listURL.loadingRequestId
  )
        ...
        children: /*#__PURE__*/ jsxs(AutoColumn, {
          ...
          children: [
            /*#__PURE__*/ jsx(Card, {
              ...
              padding: '12px 20px',
              children: /*#__PURE__*/ jsx(RowBetween, {
                children: /*#__PURE__*/ jsxs(RowFixed, {
                  children: [
                    list.logoURI &&
                      /*#__PURE__*/ jsx(ListLogo, {
    ...
    children: /*#__PURE__*/ jsxs(AutoColumn, {
      ...
      children: [
        ...
        chainId &&
          /*#__PURE__*/ jsx(ExternalLink, {
            href: getExplorerLink(chainId, token.address, ExplorerDataType.ADDRESS),
            children: /*#__PURE__*/ jsx(AddressText, {
              fontSize: 12,
              children: token.address,
            }),
          }),
...
const Wrapper$7 = _styled.div.withConfig({
...
const BlockedToken = (_ref2) => {
  let { onBack, onDismiss, blockedTokens } = _ref2
...
const Wrapper$6 = _styled.div.withConfig({
...
function ImportToken(props) {
  ...
  if (intersection.size > 0) {
    return /*#__PURE__*/ jsx(BlockedToken, {
      onBack: onBack,
      onDismiss: onDismiss,
...
const Wrapper$5 = _styled.button.withConfig({
  displayName: 'ListToggle__Wrapper',
  componentId: 'sc-1ahjqam-0',
})(
  [
    'border-radius:20px;border:none;background:',
    ';display:flex;width:fit-content;cursor:pointer;outline:none;padding:0.4rem 0.4rem;align-items:center;',
  ],
  (_ref) => {
    let { theme } = _ref
    return theme.bg1
...
const ToggleElement$1 = _styled.span.withConfig({
  ...
  let { isActive, bgColor, theme } = _ref2
...
const Wrapper$4 = _styled(Column).withConfig({
...
const PopoverContainer = _styled.div.withConfig({
  ...
  [
    ...
    ';opacity:',
    ';transition:visibility 150ms linear,opacity 150ms linear;background:',
    ';border:1px solid ',
    ';box-shadow:0px 0px 1px rgba(0,0,0,0.01),0px 4px 8px rgba(0,0,0,0.04),0px 16px 24px rgba(0,0,0,0.04),0px 24px 32px rgba(0,0,0,0.01);color:',
    ';border-radius:0.5rem;padding:1rem;display:grid;grid-template-rows:1fr;grid-gap:8px;font-size:1rem;text-align:left;',
  ],
  (props) => (props.show ? 'visible' : 'hidden'),
  (props) => (props.show ? 1 : 0),
  (_ref2) => {
...
const StyledMenu$1 = _styled.div.withConfig({
...
const RowWrapper = _styled(Row).withConfig({
  ...
  ['background-color:', ';opacity:', ';transition:200ms;align-items:center;padding:1rem;border-radius:20px;'],
  (_ref7) => {
    let { bgColor, active, theme } = _ref7
    return active ? (bgColor !== null && bgColor !== void 0 ? bgColor : 'transparent') : theme.bg2
  },
  (_ref8) => {
    let { hasActiveTokens } = _ref8
...
const ListRow = /*#__PURE__*/ memo(function ListRow(_ref9) {
  ...
  const handleRemoveList = useCallback(() => {
    ...
    if (
      window.prompt(
        /*i18n*/
        i18n._('Please confirm you would like to remove this list by typing REMOVE')
      ) === `REMOVE`
    ) {
      ReactGA.event({
        category: 'Lists',
    ...
    RowWrapper,
    {
      ...
      children: [
        ...
        /*#__PURE__*/ jsxs(Column, {
          ...
          children: [
            /*#__PURE__*/ jsx(Row, {
              children: /*#__PURE__*/ jsx(StyledTitleText, {
                active: isActive,
                children: list.name,
              }),
            }),
            /*#__PURE__*/ jsxs(RowFixed, {
              mt: '4px',
              children: [
                /*#__PURE__*/ jsx(StyledListUrlText, {
                  active: isActive,
                  mr: '6px',
                  children: /*#__PURE__*/ jsx(Trans, {
                ...
                /*#__PURE__*/ jsxs(StyledMenu$1, {
                  ref: node,
                  children: [
                    /*#__PURE__*/ jsx(ButtonEmpty, {
                      onClick: toggle,
                      ref: setReferenceElement,
                      padding: '0',
                    ...
                    open &&
                      /*#__PURE__*/ jsxs(PopoverContainer, {
                        show: true,
                        ref: setPopperElement,
                        style: styles.popper,
                        ...attributes.popper,
                        children: [
                          ...
                          /*#__PURE__*/ jsx(UnpaddedLinkStyledButton, {
...
function ManageLists(_ref10) {
  let { setModalView, setImportList, setListUrl } = _ref10
  const { chainId } = useActiveWeb3React()
  const theme = useTheme()
  ...
  const tokenCountByListName = useMemo(
    () =>
      Object.values(lists).reduce((acc, _ref11) => {
        let { current: list } = _ref11
  ...
  const sortedLists = useMemo(() => {
    ...
    return listUrls
      ...
      .sort((listUrlA, listUrlB) => {
        ...
        const { current: listB } = lists[listUrlB] // first filter on active lists

        if (
          activeListUrls !== null &&
          activeListUrls !== void 0 &&
          activeListUrls.includes(listUrlA) &&
          !(activeListUrls !== null && activeListUrls !== void 0 && activeListUrls.includes(listUrlB))
        ) {
          return -1
        }

        if (
          !(activeListUrls !== null && activeListUrls !== void 0 && activeListUrls.includes(listUrlA)) &&
          activeListUrls !== null &&
          activeListUrls !== void 0 &&
  ...
  return /*#__PURE__*/ jsxs(Wrapper$4, {
    children: [
      ...
      /*#__PURE__*/ jsx(ListContainer, {
        children: /*#__PURE__*/ jsx(AutoColumn, {
          gap: 'md',
          children: sortedLists.map((listUrl) =>
            /*#__PURE__*/ jsx(
              ListRow,
              {
                listUrl: listUrl,
...
const Wrapper$3 = _styled.div.withConfig({
...
const Footer = _styled.div.withConfig({
  ...
  [
    'position:absolute;bottom:0;width:100%;border-radius:20px;border-top-right-radius:0;border-top-left-radius:0;border-top:1px solid ',
...
function ManageTokens(_ref2) {
  let { setModalView, setImportToken } = _ref2
  const { chainId } = useActiveWeb3React()
  const [searchQuery, setSearchQuery] = useState('')
  ...
  return /*#__PURE__*/ jsxs(Wrapper$3, {
    children: [
      ...
      /*#__PURE__*/ jsx(Footer, {
        children: /*#__PURE__*/ jsx(ThemedText.DarkGray, {
          children: /*#__PURE__*/ jsx(Trans, {
...
const Wrapper$2 = _styled.div.withConfig({
...
const ToggleOption = _styled.div.withConfig({
  ...
  [
    'width:48%;padding:10px;display:flex;align-items:center;justify-content:center;border-radius:12px;font-weight:600;background-color:',
    ';color:',
    ';user-select:none;:hover{cursor:pointer;opacity:0.7;}',
  ],
  (_ref2) => {
    let { theme, active } = _ref2
...
function Manage(_ref4) {
  let { onDismiss, setModalView, setImportList, setImportToken, setListUrl } = _ref4
  ...
  return /*#__PURE__*/ jsxs(Wrapper$2, {
    children: [
      ...
      /*#__PURE__*/ jsx(PaddedColumn, {
        ...
        children: /*#__PURE__*/ jsxs(ToggleWrapper, {
          children: [
            /*#__PURE__*/ jsx(ToggleOption, {
      ...
      showLists
        ? /*#__PURE__*/ jsx(ManageLists, {
            setModalView: setModalView,
            setImportList: setImportList,
            setListUrl: setListUrl,
          })
        : /*#__PURE__*/ jsx(ManageTokens, {
            setModalView: setModalView,
            setImportToken: setImportToken,
          }),
    ],
...
function CurrencySearchModal(_ref) {
  ...
  switch (modalView) {
    case CurrencyModalView.search:
      content = /*#__PURE__*/ jsx(CurrencySearch, {
        isOpen: isOpen,
        onDismiss: onDismiss,
        onCurrencySelect: handleCurrencySelect,
        selectedCurrency: selectedCurrency,
    ...
    case CurrencyModalView.importToken:
      if (importToken) {
        content = /*#__PURE__*/ jsx(ImportToken, {
          tokens: [importToken],
          onDismiss: onDismiss,
    ...
    case CurrencyModalView.importList:
      if (importList && listURL) {
        content = /*#__PURE__*/ jsx(ImportList, {
          list: importList,
          listURL: listURL,
          onDismiss: onDismiss,
          setModalView: setModalView,
...
const TextWrapper = _styled.span.withConfig({
  ...
  (_ref4) => {
    let { adjustSize } = _ref4
    return adjustSize && '12px'
  }
)

const HoverInlineText = (_ref5) => {
  let { text, maxCharacters = 20, margin = false, adjustSize = false, fontSize, link, ...rest } = _ref5
...
function FiatValue(_ref) {
  let { fiatValue, priceImpact } = _ref
  const theme = useTheme()
  ...
  return /*#__PURE__*/ jsxs(ThemedText.Body, {
    fontSize: 14,
    ...
    children: [
      fiatValue
        ? /*#__PURE__*/ jsx(Trans, {
            id: '~$ <0/>',
            components: {
              0: /*#__PURE__*/ jsx(HoverInlineText, {
                text:
                  fiatValue === null || fiatValue === void 0
                    ? void 0
...
const InputPanel = _styled.div.withConfig({
  ...
  ['', ' position:relative;border-radius:', ';background-color:', ';z-index:1;width:', ';'],
  (_ref) => {
    let { theme } = _ref
    return theme.flexColumnNoWrap
  },
...
const FixedContainer = _styled.div.withConfig({
  ...
  [
    'width:100%;height:100%;position:absolute;border-radius:20px;background-color:',
    ';opacity:0.95;display:flex;align-items:center;justify-content:center;z-index:2;',
  ],
  (_ref5) => {
    let { theme } = _ref5
    return theme.bg1
...
const Container$1 = _styled.div.withConfig({
  displayName: 'CurrencyInputPanel__Container',
  componentId: 'sc-33m4yg-2',
})(
  ['border-radius:', ';border:1px solid ', ';background-color:', ';width:', ';:focus,:hover{border:1px solid ', ';}'],
  (_ref6) => {
    let { hideInput } = _ref6
    return hideInput ? '16px' : '20px'
  },
  (_ref7) => {
    let { theme, hideInput } = _ref7
    return hideInput ? ' transparent' : theme.bg2
  },
  (_ref8) => {
    let { theme } = _ref8
...
const CurrencySelect = _styled(ButtonGray).withConfig({
  ...
  [
    'visibility:',
    ';align-items:center;font-size:24px;font-weight:500;background-color:',
    ';color:',
    ';border-radius:16px;box-shadow:',
    ';box-shadow:0px 6px 10px rgba(0,0,0,0.075);outline:none;cursor:pointer;user-select:none;border:none;height:',
    ';width:',
    ';padding:0 8px;justify-content:space-between;margin-right:',
  ...
  (_ref12) => {
    let { selected, theme } = _ref12
    return selected ? theme.bg0 : theme.primary1
  },
  (_ref13) => {
    let { selected, theme } = _ref13
  ...
  (_ref15) => {
    let { hideInput } = _ref15
    return hideInput ? '2.8rem' : '2.4rem'
  },
  (_ref16) => {
    let { hideInput } = _ref16
    return hideInput ? '100%' : 'initial'
  },
  (_ref17) => {
    let { hideInput } = _ref17
    return hideInput ? '0' : '12px'
  },
  (_ref18) => {
    let { selected, theme } = _ref18
...
const InputRow = _styled.div.withConfig({
  ...
  ['', ' align-items:center;justify-content:space-between;padding:', ';'],
  (_ref19) => {
    let { theme } = _ref19
    return theme.flexRowNoWrap
  },
...
const LabelRow = _styled.div.withConfig({
  ...
  [
    ...
    ';font-size:0.75rem;line-height:1rem;padding:0 1rem 1rem;span:hover{cursor:pointer;color:',
    ';}',
  ],
  (_ref21) => {
    let { theme } = _ref21
...
const StyledDropDown = _styled(SvgDropdown).withConfig({
...
const StyledBalanceMax = _styled.button.withConfig({
  ...
  [
    'background-color:transparent;border:none;border-radius:12px;font-size:14px;font-weight:500;cursor:pointer;padding:0;color:',
    ';opacity:',
    ';pointer-events:',
    ';margin-left:0.25rem;:focus{outline:none;}',
    ';',
  ],
  (_ref27) => {
    let { theme } = _ref27
...
const StyledNumericalInput = _styled(Input$1).withConfig({
...
function CurrencyInputPanel(_ref31) {
  ...
  const selectedCurrencyBalance = useCurrencyBalance(
    account !== null && account !== void 0 ? account : undefined,
    currency !== null && currency !== void 0 ? currency : undefined
  )
  const theme = useTheme()
  const handleDismissSearch = useCallback(() => {
    setModalOpen(false)
  }, [setModalOpen])
  return /*#__PURE__*/ jsxs(InputPanel, {
    id: id,
    hideInput: hideInput,
    ...rest,
    children: [
      locked &&
        /*#__PURE__*/ jsx(FixedContainer, {
          children: /*#__PURE__*/ jsxs(AutoColumn, {
            gap: 'sm',
            justify: 'center',
            children: [
              /*#__PURE__*/ jsx(Lock, {}),
              /*#__PURE__*/ jsx(ThemedText.Label, {
                fontSize: '12px',
                textAlign: 'center',
                padding: '0 12px',
                children: /*#__PURE__*/ jsx(Trans, {
          ...
          /*#__PURE__*/ jsxs(InputRow, {
            ...
            children: [
              /*#__PURE__*/ jsx(CurrencySelect, {
                ...
                children: /*#__PURE__*/ jsxs(Aligner, {
                  children: [
                    /*#__PURE__*/ jsxs(RowFixed, {
                      children: [
                        pair
                          ...
                          : null,
                        pair
                          ? /*#__PURE__*/ jsxs(StyledTokenName, {
                              className: 'pair-name-container',
                              children: [
                                pair === null || pair === void 0 ? void 0 : pair.token0.symbol,
                                ':',
                                pair === null || pair === void 0 ? void 0 : pair.token1.symbol,
                              ],
                            })
                          : /*#__PURE__*/ jsx(StyledTokenName, {
              ...
              !hideInput &&
                /*#__PURE__*/ jsx(StyledNumericalInput, {
              ...
              children: /*#__PURE__*/ jsxs(RowBetween, {
                children: [
                  account
                    ...
                    : /*#__PURE__*/ jsx('span', {}),
                  /*#__PURE__*/ jsx(LoadingOpacityContainer, {
                    $loading: loading,
                    children: /*#__PURE__*/ jsx(FiatValue, {
                      fiatValue: fiatValue,
                      priceImpact: priceImpact,
                    }),
                  }),
      ...
      onCurrencySelect &&
        /*#__PURE__*/ jsx(CurrencySearchModal, {
          isOpen: modalOpen,
...
const Wrapper$1 = _styled.div.withConfig({
...
const Circle = _styled.circle.withConfig({
  ...
  [
    'stroke-dasharray:1000;stroke-dashoffset:0;-webkit-animation:',
    ' 0.9s ease-in-out;animation:',
    ' 0.9s ease-in-out;',
  ],
  dash,
  dash
...
const PolyLine = _styled.polyline.withConfig({
  ...
  [
    'stroke-dasharray:1000;stroke-dashoffset:0;stroke-dashoffset:-100;-webkit-animation:',
    ' 0.9s 0.35s ease-in-out forwards;animation:',
    ' 0.9s 0.35s ease-in-out forwards;',
  ],
  dashCheck,
  dashCheck
)
...
function ConfirmationPendingContent(_ref3) {
  let { onDismiss, pendingText, inline } = _ref3
  return /*#__PURE__*/ jsx(Wrapper, {
    children: /*#__PURE__*/ jsxs(AutoColumn, {
      ...
      children: [
        ...
        /*#__PURE__*/ jsx(ConfirmedIcon, {
          inline: inline,
          children: /*#__PURE__*/ jsx(CustomLightSpinner, {
            src: Circle$1,
            alt: 'loader',
...
function TransactionSubmittedContent(_ref4) {
  ...
  let { onDismiss, chainId, hash, currencyToAdd, inline } = _ref4
  const theme = useContext(ThemeContext)
  const { library } = useActiveWeb3React()
      ...
      children: [
        ...
        /*#__PURE__*/ jsxs(AutoColumn, {
          ...
          children: [
            ...
            currencyToAdd &&
              (library === null || library === void 0
                ? void 0
                : (_library$provider = library.provider) === null || _library$provider === void 0
                ? void 0
                : _library$provider.isMetaMask) &&
              /*#__PURE__*/ jsx(ButtonLight, {
                mt: '12px',
                padding: '6px 12px',
                width: 'fit-content',
                onClick: addToken,
...
function ConfirmationModalContent(_ref5) {
  let { title, bottomContent, onDismiss, topContent } = _ref5
...
function L2Content(_ref7) {
  ...
  let { onDismiss, chainId, hash, pendingText, inline } = _ref7
  const theme = useContext(ThemeContext)
  ...
  const transactionSuccess =
    (transaction === null || transaction === void 0
      ? void 0
      : (_transaction$receipt = transaction.receipt) === null || _transaction$receipt === void 0
      ? void 0
      : _transaction$receipt.status) === 1 // convert unix time difference to seconds

  const secondsToConfirm =
    transaction !== null && transaction !== void 0 && transaction.confirmedTime
...
function TransactionConfirmationModal(_ref8) {
  let { isOpen, onDismiss, attemptingTxn, hash, pendingText, content, currencyToAdd } = _ref8
  const { chainId } = useActiveWeb3React()
  ...
  return /*#__PURE__*/ jsx(Modal, {
    ...
    children:
      isL2 && (hash || attemptingTxn)
        ...
        : attemptingTxn
        ? /*#__PURE__*/ jsx(ConfirmationPendingContent, {
            onDismiss: onDismiss,
            pendingText: pendingText,
          })
        : hash
        ? /*#__PURE__*/ jsx(TransactionSubmittedContent, {
            chainId: chainId,
            hash: hash,
            onDismiss: onDismiss,
...
function SwapModalFooter(_ref) {
  let { onConfirm, swapErrorMessage, disabledConfirm } = _ref
  return /*#__PURE__*/ jsx(Fragment, {
    children: /*#__PURE__*/ jsxs(AutoRow, {
      children: [
        /*#__PURE__*/ jsx(ButtonError, {
          onClick: onConfirm,
        ...
        swapErrorMessage
          ? /*#__PURE__*/ jsx(SwapCallbackError, {
...
const ArrowWrapper = _styled.div.withConfig({
  ...
  [
    'padding:4px;border-radius:12px;height:32px;width:32px;position:relative;margin-top:-18px;margin-bottom:-18px;left:calc(50% - 16px);display:flex;justify-content:center;align-items:center;background-color:',
...
function SwapModalHeader(_ref3) {
  let { trade, allowedSlippage, recipient, showAcceptChanges, onAcceptChanges } = _ref3
  const theme = useContext(ThemeContext)
  ...
  return /*#__PURE__*/ jsxs(AutoColumn, {
    ...
    children: [
      ...
      /*#__PURE__*/ jsx(LightCard, {
        ...
        children: /*#__PURE__*/ jsx(AdvancedSwapDetails, {
          trade: trade,
          allowedSlippage: allowedSlippage,
        }),
      }),
      showAcceptChanges
        ? /*#__PURE__*/ jsx(SwapShowAcceptChanges, {
            justify: 'flex-start',
            gap: '0px',
            children: /*#__PURE__*/ jsxs(RowBetween, {
              children: [
      ...
      /*#__PURE__*/ jsx(AutoColumn, {
        ...
        children:
          trade.tradeType === TradeType.EXACT_INPUT
            ? /*#__PURE__*/ jsx(ThemedText.Italic, {
                fontWeight: 400,
                textAlign: 'left',
                style: {
                  width: '100%',
...
function ConfirmSwapModal(_ref) {
  ...
  const showAcceptChanges = useMemo(
    () =>
      Boolean(
        (trade instanceof Trade && originalTrade instanceof Trade && tradeMeaningfullyDiffers(trade, originalTrade)) ||
  ...
  const pendingText = /*#__PURE__*/ jsx(Trans, {
    id: 'Swapping {0} {1} for {2} {3}',
    values: {
      0:
        trade === null || trade === void 0
          ? void 0
          : (_trade$inputAmount = trade.inputAmount) === null || _trade$inputAmount === void 0
          ? void 0
          : _trade$inputAmount.toSignificant(6),
      1:
        trade === null || trade === void 0
          ? void 0
          : (_trade$inputAmount2 = trade.inputAmount) === null || _trade$inputAmount2 === void 0
          ? void 0
          : (_trade$inputAmount2$c = _trade$inputAmount2.currency) === null || _trade$inputAmount2$c === void 0
          ? void 0
          : _trade$inputAmount2$c.symbol,
      2:
        trade === null || trade === void 0
          ? void 0
          : (_trade$outputAmount = trade.outputAmount) === null || _trade$outputAmount === void 0
          ? void 0
          : _trade$outputAmount.toSignificant(6),
      3:
        trade === null || trade === void 0
          ? void 0
          : (_trade$outputAmount2 = trade.outputAmount) === null || _trade$outputAmount2 === void 0
          ? void 0
          : (_trade$outputAmount2$ = _trade$outputAmount2.currency) === null || _trade$outputAmount2$ === void 0
          ? void 0
          : _trade$outputAmount2$.symbol,
    },
  })
  ...
  const confirmationContent = useCallback(
    () =>
      swapErrorMessage
        ? /*#__PURE__*/ jsx(TransactionErrorContent, {
            onDismiss: onDismiss,
            message: swapErrorMessage,
          })
        : /*#__PURE__*/ jsx(ConfirmationModalContent, {
  ...
  return /*#__PURE__*/ jsx(TransactionConfirmationModal, {
    isOpen: isOpen,
    onDismiss: onDismiss,
...
const ToggleElement = _styled.span.withConfig({
  ...
  [
    'padding:0.25rem 0.6rem;border-radius:9px;background:',
    ';color:',
...
const StyledToggle = _styled.button.withConfig({
  ...
  [
    'border-radius:12px;border:none;background:',
    ';display:flex;width:fit-content;cursor:pointer;outline:none;padding:2px;',
  ],
  (_ref7) => {
    let { theme } = _ref7
    return theme.bg0
...
function Toggle(_ref8) {
  let {
    ...
    isActive,
    toggle,
    checked = /*#__PURE__*/ jsx(Trans, {
      id: 'On',
    }),
    unchecked = /*#__PURE__*/ jsx(Trans, {
      id: 'Off',
    }),
  } = _ref8
  return /*#__PURE__*/ jsxs(StyledToggle, {
    id: id,
    isActive: isActive,
    onClick: toggle,
    children: [
      /*#__PURE__*/ jsx(ToggleElement, {
        isActive: isActive,
        isOnSwitch: true,
        children: checked,
      }),
...
const FancyButton = _styled.button.withConfig({
  ...
  [
    'color:',
    ';align-items:center;height:2rem;border-radius:36px;font-size:1rem;width:auto;min-width:3.5rem;border:1px solid ',
...
const Input = _styled.input.withConfig({
  ...
  [
    'background:',
    ';font-size:16px;width:auto;outline:none;&::-webkit-outer-spin-button,&::-webkit-inner-spin-button{-webkit-appearance:none;}color:',
    ';text-align:right;',
  ],
  (_ref8) => {
    let { theme } = _ref8
...
const OptionCustom = _styled(FancyButton).withConfig({
  ...
  [
    'height:2rem;position:relative;padding:0 0.75rem;flex:1;border:',
    ';:hover{border:',
    ';}input{width:100%;height:100%;border:0px;border-radius:2rem;}',
  ],
  (_ref10) => {
    let { theme, active, warning } = _ref10
    return active ? `1px solid ${warning ? theme.red1 : theme.primary1}` : warning && `1px solid ${theme.red1}`
  },
  (_ref11) => {
    let { theme, active, warning } = _ref11
...
function TransactionSettings(_ref13) {
  let { placeholderSlippage } = _ref13
  const { chainId } = useActiveWeb3React()
  const theme = useContext(ThemeContext)
      ...
      /*#__PURE__*/ jsxs(AutoColumn, {
        ...
        children: [
            ...
            children: [
              ...
              /*#__PURE__*/ jsx(OptionCustom, {
                ...
                children: /*#__PURE__*/ jsxs(RowBetween, {
                  children: [
                    tooLow || tooHigh
                      ? /*#__PURE__*/ jsx(SlippageEmojiContainer, {
                          children: /*#__PURE__*/ jsx('span', {
                            role: 'img',
                            'aria-label': 'warning',
                            children: '\u26A0\uFE0F',
          ...
          slippageError || tooLow || tooHigh
            ? /*#__PURE__*/ jsx(RowBetween, {
                style: {
                  fontSize: '14px',
                  paddingTop: '7px',
                  color: slippageError ? 'red' : '#F3841E',
                },
                children: slippageError
                  ? /*#__PURE__*/ jsx(Trans, {
...
const MenuFlyout = _styled.span.withConfig({
  ...
  [
    'min-width:20.125rem;background-color:',
    ';border:1px solid ',
    ';box-shadow:0px 0px 1px rgba(0,0,0,0.01),0px 4px 8px rgba(0,0,0,0.04),0px 16px 24px rgba(0,0,0,0.04),0px 24px 32px rgba(0,0,0,0.01);border-radius:12px;display:flex;flex-direction:column;font-size:1rem;position:absolute;top:2rem;right:0rem;z-index:100;',
    ';user-select:none;',
  ],
  (_ref3) => {
    let { theme } = _ref3
    ...
    jsxs(StyledMenu, {
      ...
      children: [
        /*#__PURE__*/ jsx(Modal, {
          ...
          maxHeight: 100,
          children: /*#__PURE__*/ jsx(ModalContentWrapper, {
            children: /*#__PURE__*/ jsxs(AutoColumn, {
              gap: 'lg',
              children: [
                /*#__PURE__*/ jsxs(RowBetween, {
        ...
        /*#__PURE__*/ jsxs(StyledMenuButton, {
          onClick: toggle,
          ...
          children: [
            /*#__PURE__*/ jsx(StyledMenuIcon, {}),
            expertMode
              ? /*#__PURE__*/ jsx(EmojiWrapper, {
                  children: /*#__PURE__*/ jsx('span', {
                    role: 'img',
          ...
          /*#__PURE__*/ jsx(MenuFlyout, {
            children: /*#__PURE__*/ jsxs(AutoColumn, {
              ...
              children: [
                ...
                /*#__PURE__*/ jsx(TransactionSettings, {
...
function SwapHeader(_ref2) {
  let { allowedSlippage } = _ref2
  return /*#__PURE__*/ jsx(StyledSwapHeader, {
    children: /*#__PURE__*/ jsxs(RowBetween, {
      children: [
        /*#__PURE__*/ jsx(RowFixed, {
          children: /*#__PURE__*/ jsx(ThemedText.Black, {
...
function SwitchLocaleLink() {
  ...
  return /*#__PURE__*/ jsx(Container, {
    children: /*#__PURE__*/ jsx(Trans, {
      ...
      components: {
        0: /*#__PURE__*/ jsx(StyledInternalLink, {
          onClick: onClick,
          to: to,
        }),
      },
...
function TokenWarningModal(_ref) {
  let { isOpen, tokens, onConfirm, onDismiss } = _ref
  return /*#__PURE__*/ jsx(Modal, {
    isOpen: isOpen,
    onDismiss: onDismiss,
    maxHeight: 100,
    children: /*#__PURE__*/ jsx(ImportToken, {
      tokens: tokens,
...
function useApproveCallback(amountToApprove, spender) {
  ...
  const token =
    ...
    amountToApprove !== void 0 &&
    (_amountToApprove$curr = amountToApprove.currency) !== null &&
    _amountToApprove$curr !== void 0 &&
    _amountToApprove$curr.isToken
...
function useIsArgentWallet() {
  ...
  return (_call$result$ =
    call === null || call === void 0
      ? void 0
      : (_call$result = call.result) === null || _call$result === void 0
      ? void 0
      : _call$result[0]) !== null && _call$result$ !== void 0
    ? _call$result$
    : false
}
...
function useERC20Permit(currencyAmount, spender, overridePermitInfo) {
  ...
  const tokenAddress =
    currencyAmount !== null &&
    currencyAmount !== void 0 &&
    (_currencyAmount$curre = currencyAmount.currency) !== null &&
    _currencyAmount$curre !== void 0 &&
    _currencyAmount$curre.isToken
  ...
  const permitInfo =
    overridePermitInfo !== null && overridePermitInfo !== void 0
      ? overridePermitInfo
      : chainId && tokenAddress
      ? (_PERMITTABLE_TOKENS$c = PERMITTABLE_TOKENS[chainId]) === null || _PERMITTABLE_TOKENS$c === void 0
        ? void 0
        : _PERMITTABLE_TOKENS$c[tokenAddress]
      : undefined
  ...
  return useMemo(() => {
    ...
    const nonceNumber =
      (_tokenNonceState$resu = tokenNonceState.result) === null || _tokenNonceState$resu === void 0
        ? void 0
        : (_tokenNonceState$resu2 = _tokenNonceState$resu[0]) === null || _tokenNonceState$resu2 === void 0
        ? void 0
        : _tokenNonceState$resu2.toNumber()
...
function useERC20PermitFromTrade(trade, allowedSlippage) {
  ...
  return useERC20Permit(
    amountToApprove, // v2 router does not support
    trade instanceof Trade ? undefined : trade instanceof Trade$1 ? swapRouterAddress : undefined,
    null
  )
}
...
function useIsSwapUnsupported(currencyIn, currencyOut) {
  ...
  return useMemo(() => {
    ...
    const currencyInUnsupported = Boolean(
      (currencyIn === null || currencyIn === void 0 ? void 0 : currencyIn.isToken) &&
        unsupportedTokens[currencyIn.address]
    )
    const currencyOutUnsupported = Boolean(
      (currencyOut === null || currencyOut === void 0 ? void 0 : currencyOut.isToken) &&
        unsupportedTokens[currencyOut.address]
    )
...
function useArgentWalletContract() {
  ...
  const isArgentWallet = useIsArgentWallet()
  return useContract(
    isArgentWallet ? (account !== null && account !== void 0 ? account : undefined) : undefined,
  ...
  return useMemo(() => {
    ...
    if (trade instanceof Trade) {
      ...
      return swapMethods.map((_ref) => {
        let { methodName, args, value } = _ref
...
function swapErrorToUserReadableMessage(error) {
  ...
  while (Boolean(error)) {
    ...
    reason =
      (_ref2 = (_error$reason = error.reason) !== null && _error$reason !== void 0 ? _error$reason : error.message) !==
        null && _ref2 !== void 0
        ? _ref2
        : reason
    error =
      (_error$error = error.error) !== null && _error$error !== void 0
        ...
        ? void 0
        : _error$data.originalError
  }

  if (((_reason = reason) === null || _reason === void 0 ? void 0 : _reason.indexOf('execution reverted: ')) === 0)
  ...
  switch (reason) {
    ...
    default:
      if (
        ((_reason2 = reason) === null || _reason2 === void 0
          ? void 0
          : _reason2.indexOf('undefined is not an object')) !== -1
      ) {
...
function useWrapCallback(inputCurrency, outputCurrency, typedValue) {
  ...
  const inputAmount = useMemo(
    () => tryParseAmount(typedValue, inputCurrency !== null && inputCurrency !== void 0 ? inputCurrency : undefined),
  ...
  return useMemo(() => {
    ...
    const hasInputAmount = Boolean(
      inputAmount === null || inputAmount === void 0 ? void 0 : inputAmount.greaterThan('0')
    )
            ...
            ? async () => {
                try {
                  ...
                  addTransaction(txReceipt, {
                    ...
                    unwrapped: false,
                    currencyAmountRaw:
                      inputAmount === null || inputAmount === void 0 ? void 0 : inputAmount.quotient.toString(),
                  })
                } catch (error) {
...
const BodyWrapper$1 = _styled.main.withConfig({
  ...
  [
    ...
    ';box-shadow:0px 0px 1px rgba(0,0,0,0.01),0px 4px 8px rgba(0,0,0,0.04),0px 16px 24px rgba(0,0,0,0.04),0px 24px 32px rgba(0,0,0,0.01);border-radius:24px;margin-top:1rem;margin-left:auto;margin-right:auto;z-index:',
    ';',
  ],
  (_ref) => {
    let { margin } = _ref
...
function AppBody(_ref4) {
  let { children, ...rest } = _ref4
  return /*#__PURE__*/ jsx(BodyWrapper$1, { ...rest, children: children })
}
...
const StyledInfo = _styled(Info).withConfig({
  ...
  ['height:16px;width:16px;margin-left:4px;color:', ';:hover{color:', ';}'],
  (_ref) => {
    let { theme } = _ref
    return theme.text3
  },
...
function Swap(_ref3) {
  var _parsedAmounts$indepe3,
    _parsedAmounts$Field$,
    _currencies$Field$INP,
    _currencies$Field$INP2,
    _currencies$Field$INP3
  ...
  const urlLoadedTokens = useMemo(() => {
    ...
    return (_filter =
      (_ref4 = [loadedInputCurrency, loadedOutputCurrency]) === null || _ref4 === void 0
        ? void 0
        : _ref4.filter((c) => {
            var _c$isToken

            return (_c$isToken = c === null || c === void 0 ? void 0 : c.isToken) !== null && _c$isToken !== void 0
              ? _c$isToken
              : false
          })) !== null && _filter !== void 0
      ? _filter
  ...
  const [routeNotFound, routeIsLoading, routeIsSyncing] = useMemo(
    () => [
      trade instanceof Trade$1
        ? !(trade !== null && trade !== void 0 && trade.swaps)
        : !(trade !== null && trade !== void 0 && trade.route),
  ...
  const formattedAmounts = useMemo(() => {
    ...
    return {
      ...
      [dependentField]: showWrap
        ? (_parsedAmounts$indepe =
            (_parsedAmounts$indepe2 = parsedAmounts[independentField]) === null || _parsedAmounts$indepe2 === void 0
              ? void 0
              : _parsedAmounts$indepe2.toExact()) !== null && _parsedAmounts$indepe !== void 0
          ? _parsedAmounts$indepe
          : ''
        : (_parsedAmounts$depend =
            (_parsedAmounts$depend2 = parsedAmounts[dependentField]) === null || _parsedAmounts$depend2 === void 0
              ? void 0
              : _parsedAmounts$depend2.toSignificant(6)) !== null && _parsedAmounts$depend !== void 0
        ? _parsedAmounts$depend
        : '',
    }
  ...
  const userHasSpecifiedInputOutput = Boolean(
    currencies[Field.INPUT] &&
      ...
      ((_parsedAmounts$indepe3 = parsedAmounts[independentField]) === null || _parsedAmounts$indepe3 === void 0
        ? void 0
        : _parsedAmounts$indepe3.greaterThan(JSBI.BigInt(0)))
  ...
  const handleApprove = useCallback(async () => {
    ...
    signatureState,
    toggledVersion,
    trade === null || trade === void 0 ? void 0 : trade.inputAmount.currency.symbol,
  ...
  const showMaxButton = Boolean(
    (maxInputAmount === null || maxInputAmount === void 0 ? void 0 : maxInputAmount.greaterThan(0)) &&
      !(
        (_parsedAmounts$Field$ = parsedAmounts[Field.INPUT]) !== null &&
        _parsedAmounts$Field$ !== void 0 &&
        _parsedAmounts$Field$.equalTo(maxInputAmount)
      )
        ...
        ReactGA.event({
          ...
          label: [
            trade === null || trade === void 0
              ...
              : (_trade$inputAmount = trade.inputAmount) === null || _trade$inputAmount === void 0
              ? void 0
              : (_trade$inputAmount$cu = _trade$inputAmount.currency) === null || _trade$inputAmount$cu === void 0
              ? void 0
              : _trade$inputAmount$cu.symbol,
            trade === null || trade === void 0
              ? void 0
              : (_trade$outputAmount = trade.outputAmount) === null || _trade$outputAmount === void 0
              ? void 0
              : (_trade$outputAmount$c = _trade$outputAmount.currency) === null || _trade$outputAmount$c === void 0
              ? void 0
              : _trade$outputAmount$c.symbol,
    ...
    return warningSeverity(
      executionPriceImpact && priceImpact
        ? executionPriceImpact.greaterThan(priceImpact)
          ...
          : priceImpact
        : executionPriceImpact !== null && executionPriceImpact !== void 0
        ? executionPriceImpact
        : priceImpact
    )
  }, [priceImpact, trade])
  ...
  return /*#__PURE__*/ jsxs(Fragment, {
    children: [
      /*#__PURE__*/ jsx(TokenWarningModal, {
        isOpen: importTokensNotInDefault.length > 0 && !dismissTokenWarning,
        tokens: importTokensNotInDefault,
        onConfirm: handleConfirmTokenWarning,
        onDismiss: handleDismissTokenWarning,
      }),
      /*#__PURE__*/ jsx(NetworkAlert, {}),
      /*#__PURE__*/ jsxs(AppBody, {
        children: [
          /*#__PURE__*/ jsx(SwapHeader, {
            allowedSlippage: allowedSlippage,
          }),
          /*#__PURE__*/ jsxs(Wrapper$d, {
            id: 'swap-page',
            children: [
              /*#__PURE__*/ jsx(ConfirmSwapModal, {
                isOpen: showConfirm,
                trade: trade,
              ...
              /*#__PURE__*/ jsxs(AutoColumn, {
                ...
                children: [
                  /*#__PURE__*/ jsxs('div', {
                    ...
                    children: [
                      /*#__PURE__*/ jsx(CurrencyInputPanel, {
                        label:
                    ...
                    /*#__PURE__*/ jsxs(Row, {
                      ...
                      children: [
                        /*#__PURE__*/ jsx(RowFixed, {
                          ...
                          children: /*#__PURE__*/ jsx(MouseoverTooltipContent, {
                            wrap: false,
                            content: /*#__PURE__*/ jsx(ResponsiveTooltipContainer, {
                              children: /*#__PURE__*/ jsx(SwapRoute, {
                                trade: trade,
                            ...
                            children: /*#__PURE__*/ jsxs(AutoRow, {
                              ...
                              width: 'auto',
                              children: [
                                /*#__PURE__*/ jsx(AutoRouterLogo, {}),
                                /*#__PURE__*/ jsx(LoadingOpacityContainer, {
                                  $loading: routeIsSyncing,
                                  children:
                                    trade instanceof Trade$1 &&
                                    trade.swaps.length > 1 &&
                                    /*#__PURE__*/ jsxs(ThemedText.Blue, {
                                      fontSize: 14,
                        ...
                        /*#__PURE__*/ jsxs(RowFixed, {
                          children: [
                            /*#__PURE__*/ jsx(LoadingOpacityContainer, {
                              $loading: routeIsSyncing,
                              children: /*#__PURE__*/ jsx(TradePrice, {
                                price: trade.executionPrice,
                                showInverted: showInverted,
                                setShowInverted: setShowInverted,
                              }),
                            }),
                            /*#__PURE__*/ jsx(MouseoverTooltipContent, {
                              wrap: false,
                              content: /*#__PURE__*/ jsx(ResponsiveTooltipContainer, {
                                origin: 'top right',
                                width: '295px',
                              ...
                              children: /*#__PURE__*/ jsx(StyledInfo, {}),
                            }),
                          ],
                        }),
                      ],
                    ...
                    children: [
                      swapIsUnsupported
                        ...
                        ? /*#__PURE__*/ jsx(ButtonPrimary, {
                            ...
                            onClick: onWrap,
                            children:
                              wrapInputError !== null && wrapInputError !== void 0
                                ? wrapInputError
                                : wrapType === WrapType.WRAP
                                ? /*#__PURE__*/ jsx(Trans, {
                                    id: 'Wrap',
                                        ...
                                        children: [
                                          ...
                                          signatureState === UseERC20PermitState.SIGNED
                                            ? /*#__PURE__*/ jsx(Trans, {
                                                ...
                                                values: {
                                                  0:
                                                    (_currencies$Field$INP = currencies[Field.INPUT]) === null ||
                                                    _currencies$Field$INP === void 0
                                                      ? void 0
                                                      : _currencies$Field$INP.symbol,
                                                },
                                              })
                                            : /*#__PURE__*/ jsx(Trans, {
                                                ...
                                                values: {
                                                  0:
                                                    (_currencies$Field$INP2 = currencies[Field.INPUT]) === null ||
                                                    _currencies$Field$INP2 === void 0
                                                      ? void 0
                                                      : _currencies$Field$INP2.symbol,
                                                },
                                              }),
                                        ],
                                      }),
                                      approvalState === ApprovalState.PENDING
                                        ...
                                        : /*#__PURE__*/ jsx(MouseoverTooltip, {
                                            text: /*#__PURE__*/ jsx(Trans, {
                                              ...
                                              values: {
                                                0:
                                                  (_currencies$Field$INP3 = currencies[Field.INPUT]) === null ||
                                                  _currencies$Field$INP3 === void 0
                                                    ? void 0
                                                    : _currencies$Field$INP3.symbol,
                                              },
                                            }),
      ...
      /*#__PURE__*/ jsx(SwitchLocaleLink, {}),
      !swapIsUnsupported
        ? null
        : /*#__PURE__*/ jsx(UnsupportedCurrencyFooter, {
...
const BodyWrapper = _styled.div.withConfig({
  ...
  [
    'display:flex;flex-direction:column;width:100%;padding:120px 16px 0px 16px;align-items:center;flex:1;z-index:1;',
    ';',
  ],
  (_ref) => {
    let { theme } = _ref
...
function TopLevelModals() {
  ...
  return /*#__PURE__*/ jsx(AddressClaimModal, {
    isOpen: open,
    onDismiss: toggle,
  })
}
...
function App() {
  return /*#__PURE__*/ jsxs(ErrorBoundary, {
    children: [
      /*#__PURE__*/ jsx(Route$2, {
        component: DarkModeQueryParamReader,
      }),
      /*#__PURE__*/ jsx(Route$2, {
        component: ApeModeQueryParamReader,
      }),
      /*#__PURE__*/ jsx(Web3ReactManager, {
        children: /*#__PURE__*/ jsxs(AppWrapper, {
          children: [
            /*#__PURE__*/ jsx(HeaderWrapper, {
              children: /*#__PURE__*/ jsx(Header$2, {}),
            }),
            /*#__PURE__*/ jsxs(BodyWrapper, {
              children: [
                /*#__PURE__*/ jsx(Popups, {}),
                /*#__PURE__*/ jsx(Polling, {}),
                /*#__PURE__*/ jsx(TopLevelModals, {}),
...
function Updater$5() {
  ...
  useEffect(() => {
    ...
    dispatch(
      updateChainId({
        chainId: debouncedState.chainId
          ? (_supportedChainId = supportedChainId(debouncedState.chainId)) !== null && _supportedChainId !== void 0
            ? _supportedChainId
            : null
          : null,
      })
...
function Updater$1() {
  ...
  const transactions = useMemo(() => {
    ...
    return chainId
      ? (_state$chainId = state[chainId]) !== null && _state$chainId !== void 0
        ? _state$chainId
        : {}
      : {}
  ...
  const getReceipt = useCallback(
    (hash) => {
      ...
      const retryOptions =
        (_RETRY_OPTIONS_BY_CHA = RETRY_OPTIONS_BY_CHAIN_ID[chainId]) !== null && _RETRY_OPTIONS_BY_CHA !== void 0
...
function Updater() {
  ...
  useEffect(() => {
    ...
    const match =
      (_window = window) === null || _window === void 0 ? void 0 : _window.matchMedia('(prefers-color-scheme: dark)')
    dispatch(
      updateMatchesDarkMode({
        matchesDarkMode: match.matches,
      })
...
const setBackground = (newValues) =>
  Object.entries(newValues).forEach((_ref) => {
    let [key, value] = _ref
...
function Updaters() {
  return /*#__PURE__*/ jsxs(Fragment, {
    children: [
      /*#__PURE__*/ jsx(RadialGradientByChainUpdater, {}),
      /*#__PURE__*/ jsx(Updater$4, {}),
      /*#__PURE__*/ jsx(Updater, {}),
      /*#__PURE__*/ jsx(Updater$5, {}),
      /*#__PURE__*/ jsx(Updater$1, {}),
      /*#__PURE__*/ jsx(Updater$2, {}),
      /*#__PURE__*/ jsx(Updater$3, {}),
    ],
  })
}
  ...
  /*#__PURE__*/ jsx(Provider, {
    ...
    children: /*#__PURE__*/ jsx(HashRouter, {
      children: /*#__PURE__*/ jsx(LanguageProvider, {
        children: /*#__PURE__*/ jsx(Web3ReactProvider, {
          getLibrary: getLibrary,
          children: /*#__PURE__*/ jsx(Web3ProviderNetwork, {
            getLibrary: getLibrary,
            children: /*#__PURE__*/ jsxs(Blocklist, {
              children: [
                /*#__PURE__*/ jsx(Updaters, {}),
                /*#__PURE__*/ jsxs(ThemeProvider, {
                  children: [/*#__PURE__*/ jsx(ThemedGlobalStyle, {}), props.children],
                }),
              ],
            }),
          }),
...
//# sourceMappingURL=snowflake.esm.js.map
