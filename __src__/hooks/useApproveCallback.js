...
export function useApproveCallbackFromTrade(trade, allowedSlippage) {
  ...
  return useApproveCallback(amountToApprove, chainId ? trade instanceof V2Trade ? V2_ROUTER_ADDRESS[chainId] : trade instanceof V3Trade ? v3SwapRouterAddress : undefined : undefined);
}