...
const mockUseRoutingAPITrade = useRoutingAPITrade; // useClientSideV3Trade mocks

const mockUseClientSideV3Trade = useClientSideV3Trade; // helpers to set mock expectations

const expectRouterMock = state => {
  mockUseRoutingAPITrade.mockReturnValue({
    state,
    trade: null
  });
};

const expectClientSideMock = state => {
  mockUseClientSideV3Trade.mockReturnValue({
    state,
    trade: null
  });
};
