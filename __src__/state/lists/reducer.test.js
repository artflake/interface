...
const PATCHED_STUB_LIST = { ...STUB_TOKEN_LIST,
  version: { ...STUB_TOKEN_LIST.version,
    patch: STUB_TOKEN_LIST.version.patch + 1
  }
};
const MINOR_UPDATED_STUB_LIST = { ...STUB_TOKEN_LIST,
  version: { ...STUB_TOKEN_LIST.version,
    minor: STUB_TOKEN_LIST.version.minor + 1
  }
};
const MAJOR_UPDATED_STUB_LIST = { ...STUB_TOKEN_LIST,
  version: { ...STUB_TOKEN_LIST.version,
...
describe('list reducer', () => {
  ...
  describe('fetchTokenList', () => {
    describe('pending', () => {
      it('sets pending', () => {
        store.dispatch(fetchTokenList.pending({
    ...
    describe('fulfilled', () => {
      it('saves the list', () => {
        store.dispatch(fetchTokenList.fulfilled({
    ...
    describe('rejected', () => {
      it('no-op if not loading', () => {
        store.dispatch(fetchTokenList.rejected({
          requestId: 'request-id',
          errorMessage: 'abcd',
          url: 'fake-url'
        }));
  ...
  describe('updateVersion', () => {
    ...
    describe('initialized with a different set of lists', () => {
      ...
      it('each of those initialized lists is empty', () => {
        const byUrl = store.getState().byUrl; // note we don't expect the uniswap default list to be prepopulated
        // this is ok.
