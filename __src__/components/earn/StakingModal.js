...
})(["display:flex;justify-content:space-between;padding-right:20px;padding-left:20px;opacity:", ";"], _ref => {
  let {
    dim
  } = _ref;
  return dim ? 0.5 : 1;
...
export default function StakingModal(_ref2) {
  ...
  if (parsedAmountWrapped !== null && parsedAmountWrapped !== void 0 && parsedAmountWrapped.greaterThan('0')) {
  ...
  return /*#__PURE__*/_jsxs(Modal, {
    ...
    children: [!attempting && !hash && /*#__PURE__*/_jsxs(ContentWrapper, {
      ...
      children: [/*#__PURE__*/_jsxs(RowBetween, {
        ...
        pair: dummyPair,
        label: '',
        renderBalance: amount => /*#__PURE__*/_jsx(Trans, {
      ...
      }), /*#__PURE__*/_jsxs(HypotheticalRewardRate, {
    ...
    }), attempting && hash && /*#__PURE__*/_jsx(SubmittedView, {
      onDismiss: wrappedOnDismiss,
      hash: hash,
      children: /*#__PURE__*/_jsxs(AutoColumn, {
        gap: "12px",
