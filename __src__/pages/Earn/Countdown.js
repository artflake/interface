...
export function Countdown(_ref) {
  let {
    exactEnd
  } = _ref;
  ...
  return /*#__PURE__*/_jsxs(ThemedText.Black, {
    fontWeight: 400,
    children: [message, ' ', Number.isFinite(timeRemaining) && /*#__PURE__*/_jsx("code", {
      children: `${days}:${hours.toString().padStart(2, '0')}:${minutes.toString().padStart(2, '0')}:${seconds.toString().padStart(2, '0')}`
    })]
  });
}